...
WORKDIR /src
COPY ["Polkanalysis.Worker/Polkanalysis.Worker.csproj", "Polkanalysis.Worker/"]
RUN dotnet restore "Polkanalysis.Worker/Polkanalysis.Worker.csproj"
COPY . .
WORKDIR "/src/Polkanalysis.Worker"
