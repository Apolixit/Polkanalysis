...
namespace Substats.Infrastructure.Tests.Polkadot.Repository.Pallet.Staking
{
    public class StakingStorageTests : PolkadotRepositoryMock
    {
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.EnumRewardDestination();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.ValidatorPrefs();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.Nominations();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.ActiveEraInfo();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.Exposure();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.EraRewardPoints();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.EnumForcing();
            coreResult.Create(Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.Forcing.NotForcing);
        ...
        {
            await MockStorageCallNullAsync<
                Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.EnumForcing, EnumForcing>(_substrateRepository.Storage.Staking.ForceEraAsync);
        }
        ...
        {
            var perbill = new Substats.Polkadot.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill();
            perbill.Create("0x00000000");
            var coreResult = new BaseTuple<Substats.Polkadot.NetApiExt.Generated.Model.sp_arithmetic.per_things.Perbill, U128>();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.slashing.SlashingSpans();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.pallet_staking.slashing.SpanRecord();
        ...
        {
            var coreResult = new Substats.Polkadot.NetApiExt.Generated.Model.sp_arithmetic.per_things.Percent();
