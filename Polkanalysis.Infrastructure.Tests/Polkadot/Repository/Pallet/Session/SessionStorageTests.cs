...
namespace Substats.Infrastructure.Tests.Polkadot.Repository.Pallet.Session
{
    public class SessionStorageTests : PolkadotRepositoryMock
    {
        ...
        {
            var coreResult = new BaseVec<BaseTuple<AccountId32, Substats.Polkadot.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys>>();
