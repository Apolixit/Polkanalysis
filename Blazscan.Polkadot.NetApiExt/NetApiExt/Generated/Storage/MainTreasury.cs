...
namespace Blazscan.Polkadot.NetApiExt.Generated.Storage
{
    ...
    public sealed class TreasuryStorage
    {
        ...
        public TreasuryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Proposals"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(Blazscan.Polkadot.NetApiExt.Generated.Model.pallet_treasury.Proposal)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Approvals"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Blazscan.Polkadot.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT12)));
        }
        ...
        ///  Proposals that have been made.
        /// </summary>
        public async Task<Blazscan.Polkadot.NetApiExt.Generated.Model.pallet_treasury.Proposal> Proposals(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = TreasuryStorage.ProposalsParams(key);
            return await _client.GetStorageAsync<Blazscan.Polkadot.NetApiExt.Generated.Model.pallet_treasury.Proposal>(parameters, token);
        }
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public async Task<Blazscan.Polkadot.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT12> Approvals(CancellationToken token)
        {
    ...
    public sealed class TreasuryCalls
    {
        ...
        /// </summary>
        public static Method ProposeSpend(Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> value, Blazscan.Polkadot.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Spend(Ajuna.NetApi.Model.Types.Base.BaseCom<Ajuna.NetApi.Model.Types.Primitive.U128> amount, Blazscan.Polkadot.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
