...
namespace Blazscan.Polkadot.NetApiExt.Generated.Storage
{
    ...
    public sealed class FastUnstakeStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FastUnstake", "Head"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Blazscan.Polkadot.NetApiExt.Generated.Model.pallet_fast_unstake.types.UnstakeRequest)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("FastUnstake", "Queue"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Blazscan.Polkadot.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Ajuna.NetApi.Model.Types.Primitive.U128)));
        ...
        ///  The current "head of the queue" being unstaked.
        /// </summary>
        public async Task<Blazscan.Polkadot.NetApiExt.Generated.Model.pallet_fast_unstake.types.UnstakeRequest> Head(CancellationToken token)
        {
            string parameters = FastUnstakeStorage.HeadParams();
            return await _client.GetStorageAsync<Blazscan.Polkadot.NetApiExt.Generated.Model.pallet_fast_unstake.types.UnstakeRequest>(parameters, token);
        }
        ...
        /// </summary>
        public static string QueueParams(Blazscan.Polkadot.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Keeps track of `AccountId` wishing to unstake and it's corresponding deposit.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U128> Queue(Blazscan.Polkadot.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
