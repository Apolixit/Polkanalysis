    ...
    public sealed class ParasDisputesStorage
    {
        ...
        public ParasDisputesStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParasDisputes", "Disputes"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash>), typeof(Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParasDisputes", "Included"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat,
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash>), typeof(Ajuna.NetApi.Model.Types.Primitive.U32)));
        ...
        /// </summary>
        public static string DisputesParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key)
        {
        ...
        ///  All ongoing or concluded disputes for the last several sessions.
        /// </summary>
        public async Task<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState> Disputes(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key, CancellationToken token)
        {
            string parameters = ParasDisputesStorage.DisputesParams(key);
            return await _client.GetStorageAsync<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState>(parameters, token);
        }
        ...
        /// </summary>
        public static string IncludedParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key)
        {
        ...
        ///  should be reverted back to if the candidate is disputed and determined to be invalid.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U32> Included(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.CandidateHash> key, CancellationToken token)
        {
