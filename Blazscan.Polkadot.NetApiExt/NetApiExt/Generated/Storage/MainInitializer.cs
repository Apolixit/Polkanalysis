...
namespace Blazscan.Polkadot.NetApiExt.Generated.Storage
{
    ...
    public sealed class InitializerStorage
    {
        ...
        public InitializerStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Initializer", "BufferedSessionChanges"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.initializer.BufferedSessionChange>)));
        }
        ...
        ///  upgrade boundaries or if governance intervenes.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.initializer.BufferedSessionChange>> BufferedSessionChanges(CancellationToken token)
        {
            string parameters = InitializerStorage.BufferedSessionChangesParams();
            return await _client.GetStorageAsync<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_runtime_parachains.initializer.BufferedSessionChange>>(parameters, token);
        }
    }
