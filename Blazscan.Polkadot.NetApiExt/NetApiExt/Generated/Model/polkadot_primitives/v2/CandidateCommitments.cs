...
namespace Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_primitives.v2
{
    ...
    /// <summary>
    /// >> 391 - Composite[polkadot_primitives.v2.CandidateCommitments]
    /// </summary>
    ...
    public sealed class CandidateCommitments : BaseType
    {
        ...
        /// >> horizontal_messages
        /// </summary>
        private Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage> _horizontalMessages;
        
        /// <summary>
        /// >> new_validation_code
        /// </summary>
        private Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_parachain.primitives.ValidationCode> _newValidationCode;
        
        /// <summary>
        /// >> head_data
        /// </summary>
        private Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData _headData;
        ...
        public Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage> HorizontalMessages
        {
            get
            {
        ...
        public Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_parachain.primitives.ValidationCode> NewValidationCode
        {
            get
            {
        ...
        public Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData HeadData
        {
            get
            {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            HorizontalMessages = new Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>();
            HorizontalMessages.Decode(byteArray, ref p);
            NewValidationCode = new Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_parachain.primitives.ValidationCode>();
            NewValidationCode.Decode(byteArray, ref p);
            HeadData = new Blazscan.Polkadot.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData();
