...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParaSchedulerStorage
    {
        ...
        ///  multiplied by the number of parathread multiplexer cores. Reasonably, 10 * 50 = 500.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.ParathreadClaimQueue> ParathreadQueue(CancellationToken token)
        {
            string parameters = ParaSchedulerStorage.ParathreadQueueParams();
            return await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_runtime_parachains.scheduler.ParathreadClaimQueue>(parameters, token);
        }
