...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_primitives.v2
{
    ...
    public sealed class CandidateCommitments : BaseType
    {
        ...
        /// >> horizontal_messages
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage> _horizontalMessages;
        
        /// <summary>
        /// >> new_validation_code
        /// </summary>
        private Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_parachain.primitives.ValidationCode> _newValidationCode;
        
        /// <summary>
        /// >> head_data
        /// </summary>
        private Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData _headData;
        ...
        public Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage> HorizontalMessages
        {
            get
            {
        ...
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_parachain.primitives.ValidationCode> NewValidationCode
        {
            get
            {
        ...
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData HeadData
        {
            get
            {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            HorizontalMessages = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_core_primitives.OutboundHrmpMessage>();
            HorizontalMessages.Decode(byteArray, ref p);
            NewValidationCode = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_parachain.primitives.ValidationCode>();
            NewValidationCode.Decode(byteArray, ref p);
            HeadData = new Polkanalysis.Kusama.NetApiExt.Generated.Model.polkadot_parachain.primitives.HeadData();
