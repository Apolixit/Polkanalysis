...
namespace Polkanalysis.Infrastructure.Blockchain.Contracts.Pallet.PolkadotRuntimeParachain.ParaInherent.Enum
{
    [DomainMapping("polkadot_runtime_parachains/paras_inherent/pallet")]
    public enum Error
    {
