...
namespace Polkanalysis.Infrastructure.Blockchain.Integration.Tests.Polkadot.Repository.Pallet.Staking
{
    public class StakingStorageTests : PolkadotIntegrationTest
    {
        ...
        {
            var era = await _substrateService.Storage.Staking.CurrentEraAsync(CancellationToken.None);
        ...
        {
            var era = await _substrateService.Storage.Staking.CurrentEraAsync(CancellationToken.None);
            var query = await _substrateService.Storage.Staking.ErasStakersQueryAsync(era.Value, CancellationToken.None);
        ...
        {
            var res = await _substrateService.Storage.Staking.ValidatorCountAsync(CancellationToken.None);
        ...
        {
            var res = await _substrateService.Storage.Staking.MinimumValidatorCountAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.InvulnerablesAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.MinNominatorBondAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.MinValidatorBondAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.MinCommissionAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        public async Task Ledger_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.LedgerAsync(new SubstrateAccount(""), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.PayeeAsync(new SubstrateAccount("12mvRSJUwpf6VfWLmgEJjcQgzzh2bCTSvFDwrykmijdzqS5m"), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.ValidatorsAsync(new SubstrateAccount("1zugcag7cJVBtVRnFxv5Qftn7xKAnR6YJ9x4x3XLgGgmNnS"), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.CounterForValidatorsAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        public async Task Nominators_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.NominatorsAsync(allNominators.First().Item1, CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var nominatorsQuery = await _substrateService.Storage.Staking.NominatorsQueryAsync(CancellationToken.None);
        ...
        {
            var res = await _substrateService.Storage.Staking.CounterForNominatorsAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        public async Task MaxNominatorsCount_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.MaxNominatorsCountAsync(CancellationToken.None);
        ...
        {
            var res = await _substrateService.Storage.Staking.CurrentEraAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.ActiveEraAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.ErasStartSessionIndexAsync(await GetLastFinishedEraAsync(), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        public async Task ErasStakers_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.ErasStakersAsync(new BaseTuple<U32, SubstrateAccount>(era, staker), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        public async Task ErasStakersOverview_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.ErasStakersOverviewAsync(new BaseTuple<U32, SubstrateAccount>(era, staker), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        public async Task ErasStakersPaged_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.ErasStakersPagedAsync(new BaseTuple<U32, SubstrateAccount ,U32>(era, staker, new U32(0)), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        ...
        {
            var currentEra = await _substrateService.Storage.Staking.CurrentEraAsync(CancellationToken.None);
            var nbValidators = await _substrateService.Storage.Staking.ValidatorCountAsync(CancellationToken.None);
            var query = await _substrateService.Storage.Staking.ErasStakersQueryAsync(currentEra.Value, CancellationToken.None);
        ...
        public async Task ErasStakersClipped_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.ErasStakersClippedAsync(new BaseTuple<U32, SubstrateAccount>(era, staker), CancellationToken.None);
            Assert.That(res, Is.Null);
        }
        ...
        {
            var (era, staker) = await GetValidatorFromThisEraAsync();
            var res = await _substrateService.Storage.Staking.ErasValidatorPrefsAsync(new BaseTuple<U32, SubstrateAccount>(era, staker), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.ErasValidatorRewardAsync(
        ...
        {
            var era = await _substrateService.Storage.Staking.CurrentEraAsync(CancellationToken.None);
            var res = await _substrateService.Storage.Staking.ErasRewardPointsAsync(await GetLastFinishedEraAsync(), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.ErasTotalStakeAsync(await GetLastFinishedEraAsync(), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        public async Task ForceEra_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.ForceEraAsync(CancellationToken.None);
            Assert.That(res, Is.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.SlashRewardFractionAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.CanceledSlashPayoutAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.UnappliedSlashesAsync(new U32(959), CancellationToken.None);
            Assert.That(res, Is.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.BondedErasAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        public async Task ValidatorSlashInEra_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.ValidatorSlashInEraAsync(new BaseTuple<U32, SubstrateAccount>(era, staker), CancellationToken.None);
            Assert.That(res, Is.Null);
        }
        ...
        public async Task NominatorSlashInEra_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.NominatorSlashInEraAsync(new BaseTuple<U32, SubstrateAccount>(era, staker), CancellationToken.None);
            Assert.That(res, Is.Null);
        }
        ...
        public async Task SlashingSpans_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.SlashingSpansAsync(staker, CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        public async Task SpanSlash_ShouldWorkAsync()
        {
            ...
            var res = await _substrateService.Storage.Staking.SpanSlashAsync(new BaseTuple<SubstrateAccount, U32>(staker, index), CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.Storage.Staking.CurrentPlannedSessionAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        {
            var res = await _substrateService.At(18111046).Storage.Staking.OffendingValidatorsAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
        ...
        //{
        //    var res = await _substrateService.Storage.Staking.StorageVersionAsync(CancellationToken.None);
        ...
        {
            var res = await _substrateService.Storage.Staking.ChillThresholdAsync(CancellationToken.None);
            Assert.That(res, Is.Not.Null);
        }
    }
}
