...
// Summary:
//     Extrinsic
public class TempOldExtrinsic : IExtrinsic
{
    //
    // Summary:
    //     Signed
...
public class ExtrinsicOldJsonConverter : JsonConverter<TempOldExtrinsic>
{
    private readonly ChargeType _chargeType;

    public ExtrinsicOldJsonConverter(ChargeType chargeType)
    {
    ...
    public override TempOldExtrinsic ReadJson(JsonReader reader, Type objectType, TempOldExtrinsic existingValue,
        bool hasExistingValue, JsonSerializer serializer)
    {
        return new TempOldExtrinsic((string)reader.Value, _chargeType);
    }
    ...
    public override void WriteJson(JsonWriter writer, TempOldExtrinsic value, JsonSerializer serializer)
    {
