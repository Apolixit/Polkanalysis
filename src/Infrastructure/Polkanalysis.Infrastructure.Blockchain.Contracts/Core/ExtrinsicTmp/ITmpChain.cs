...
{
    public interface ITmpChain
    {
        /// <summary>
        /// Get header and body of a relay chain block
        /// </summary>
        /// <returns></returns>
        Task<IBlockData> GetBlockAsync();
        ...
        /// <returns></returns>
        Task<IBlockData> GetBlockAsync(CancellationToken token);
        ...
        /// <returns></returns>
        Task<IBlockData> GetBlockAsync(Hash hash);
        ...
        /// <param name="token"></param>
        /// <returns></returns>
        Task<IBlockData> GetBlockAsync(Hash hash, CancellationToken token);
