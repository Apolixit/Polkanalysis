...
namespace Polkanalysis.Infrastructure.Database.Contracts.Model.Events.Auctions
{
    ...
    {
        [SetsRequiredMembers]
        public AuctionsAuctionStartedModel(string blockchainName, uint blockId, DateTime blockDate, uint eventId, string moduleName, string moduleEvent, uint auctionIndex, uint leasePeriod, uint ending) : base(blockchainName, blockId, blockDate, eventId, moduleName, moduleEvent)
        {
