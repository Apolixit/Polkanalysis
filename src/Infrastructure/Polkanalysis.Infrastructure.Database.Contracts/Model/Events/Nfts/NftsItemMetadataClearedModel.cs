...
namespace Polkanalysis.Infrastructure.Database.Contracts.Model.Events.Nfts
{
    ...
    {
        [SetsRequiredMembers]
        public NftsItemMetadataClearedModel(string blockchainName, uint blockId, DateTime blockDate, uint eventId, string moduleName, string moduleEvent, double collection, string item) : base(blockchainName, blockId, blockDate, eventId, moduleName, moduleEvent)
        {
