...
namespace Polkanalysis.Infrastructure.Database.Contracts.Model.Events.NominationPools
{
    ...
    {
        [SetsRequiredMembers]
        public NominationPoolsDestroyedModel(string blockchainName, uint blockId, DateTime blockDate, uint eventId, string moduleName, string moduleEvent, uint pool_id) : base(blockchainName, blockId, blockDate, eventId, moduleName, moduleEvent)
        {
