...
namespace Polkanalysis.Infrastructure.Database.Contracts.Model.Events.NominationPools
{
    ...
    {
        [SetsRequiredMembers]
        public NominationPoolsWithdrawnModel(string blockchainName, uint blockId, DateTime blockDate, uint eventId, string moduleName, string moduleEvent, string member, uint pool_id, double balance, double points) : base(blockchainName, blockId, blockDate, eventId, moduleName, moduleEvent)
        {
            this.Member = member;
