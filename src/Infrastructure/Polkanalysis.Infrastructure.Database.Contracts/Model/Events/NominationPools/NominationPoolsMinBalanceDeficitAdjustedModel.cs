...
namespace Polkanalysis.Infrastructure.Database.Contracts.Model.Events.NominationPools
{
    ...
    {
        [SetsRequiredMembers]
        public NominationPoolsMinBalanceDeficitAdjustedModel(string blockchainName, uint blockId, DateTime blockDate, uint eventId, string moduleName, string moduleEvent, uint pool_id, double amount) : base(blockchainName, blockId, blockDate, eventId, moduleName, moduleEvent)
        {
