...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.pallet_proxy
{
    /// <summary>
    /// >> 14455 - Composite[pallet_proxy.ProxyDefinition]
    /// </summary>
    ...
    public sealed class ProxyDefinition : ProxyDefinitionBase
    {
        ...
        {
            var start = p;
            Delegate = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.sp_core.crypto.AccountId32();
            Delegate.Decode(byteArray, ref p);
            ProxyType = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.kusama_runtime.EnumProxyType();
