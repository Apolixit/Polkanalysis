...
{
    /// <summary>
    /// >> 14561 - Composite[polkadot_primitives.v2.SessionInfo]
    /// </summary>
    ...
    public sealed class SessionInfo : SessionInfoBase
    {
        ...
        {
            var start = p;
            ActiveValidatorIndices = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.polkadot_primitives.v2.ValidatorIndex>();
            ...
            Validators = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.polkadot_primitives.v2.validator_app.Public>();
            Validators.Decode(byteArray, ref p);
            DiscoveryKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.sp_authority_discovery.app.Public>();
            DiscoveryKeys.Decode(byteArray, ref p);
            AssignmentKeys = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.polkadot_primitives.v2.assignment_app.Public>();
            AssignmentKeys.Decode(byteArray, ref p);
            ValidatorGroups = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.polkadot_primitives.v2.ValidatorIndex>>();
