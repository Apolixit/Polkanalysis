...
{
    /// <summary>
    /// >> 14345 - Composite[polkadot_primitives.v2.CandidateCommitments]
    /// </summary>
    ...
    public sealed class CandidateCommitments : CandidateCommitmentsBase
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            HorizontalMessages = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.polkadot_core_primitives.OutboundHrmpMessage>();
            HorizontalMessages.Decode(byteArray, ref p);
            NewValidationCode = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.polkadot_parachain.primitives.ValidationCode>();
            NewValidationCode.Decode(byteArray, ref p);
            HeadData = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.polkadot_parachain.primitives.HeadData();
