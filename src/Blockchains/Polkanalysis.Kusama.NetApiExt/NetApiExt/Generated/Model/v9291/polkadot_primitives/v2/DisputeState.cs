...
{
    /// <summary>
    /// >> 8403 - Composite[polkadot_primitives.v2.DisputeState]
    /// </summary>
    ...
    public sealed class DisputeState : DisputeStateBase
    {
        ...
        {
            var start = p;
            ValidatorsFor = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.bitvec.order.Lsb0>();
            ValidatorsFor.Decode(byteArray, ref p);
            ValidatorsAgainst = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.bitvec.order.Lsb0>();
