...
{
    /// <summary>
    /// >> 3320 - Composite[pallet_nis.pallet.SummaryRecord]
    /// </summary>
    ...
    public sealed class SummaryRecord : SummaryRecordBase
    {
        ...
        {
            var start = p;
            ProportionOwed = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9370.sp_arithmetic.per_things.Perquintill();
            ProportionOwed.Decode(byteArray, ref p);
            Index = new Substrate.NetApi.Model.Types.Primitive.U32();
            Index.Decode(byteArray, ref p);
            Thawed = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9370.sp_arithmetic.per_things.Perquintill();
