...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.vbase.polkadot_runtime_parachains.configuration.migration.v1
{
    /// <summary>
    /// >> 20831 - Composite[polkadot_runtime_parachains.configuration.migration.v1.HostConfigurationBase]
    /// </summary>
    ...
    public abstract class HostConfigurationBase : BaseType
    {
        ...
        public static Polkanalysis.Kusama.NetApiExt.Generated.Model.vbase.polkadot_runtime_parachains.configuration.migration.v1.HostConfigurationBase Create(byte[] data, uint version)
        {
            Polkanalysis.Kusama.NetApiExt.Generated.Model.vbase.polkadot_runtime_parachains.configuration.migration.v1.HostConfigurationBase instance = null;
            if (version == 9190U)
            {
                instance = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.polkadot_runtime_parachains.configuration.migration.v1.HostConfiguration();
                instance.Create(data);
            }

            if (version == 9180U)
            {
                instance = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9180.polkadot_runtime_parachains.configuration.migration.v1.HostConfiguration();
                instance.Create(data);
            }

            if (version == 9170U)
            {
                instance = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.polkadot_runtime_parachains.configuration.migration.v1.HostConfiguration();
                instance.Create(data);
            }

            if (version == 9160U)
            {
                instance = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9160.polkadot_runtime_parachains.configuration.migration.v1.HostConfiguration();
                instance.Create(data);
            }
