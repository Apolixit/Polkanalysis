...
{
    /// <summary>
    /// >> 20454 - Composite[polkadot_primitives.v4.CandidateCommitmentsBase]
    /// </summary>
    ...
    public abstract class CandidateCommitmentsBase : BaseType
    {
        ...
        public static Polkanalysis.Kusama.NetApiExt.Generated.Model.vbase.polkadot_primitives.v4.CandidateCommitmentsBase Create(byte[] data, uint version)
        {
            Polkanalysis.Kusama.NetApiExt.Generated.Model.vbase.polkadot_primitives.v4.CandidateCommitmentsBase instance = null;
            if (version == 9430U)
            {
                instance = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.CandidateCommitments();
                instance.Create(data);
            }

            if (version == 9420U)
            {
                instance = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.polkadot_primitives.v4.CandidateCommitments();
                instance.Create(data);
            }
