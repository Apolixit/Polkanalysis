...
{
    /// <summary>
    /// >> 13596 - Composite[polkadot_primitives.v2.CommittedCandidateReceipt]
    /// </summary>
    ...
    public sealed class CommittedCandidateReceipt : CommittedCandidateReceiptBase
    {
        ...
        {
            var start = p;
            Descriptor = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9200.polkadot_primitives.v2.CandidateDescriptor();
            Descriptor.Decode(byteArray, ref p);
            Commitments = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9200.polkadot_primitives.v2.CandidateCommitments();
