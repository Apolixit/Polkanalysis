...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_proxy
{
    /// <summary>
    /// >> 1542 - Composite[pallet_proxy.ProxyDefinition]
    /// </summary>
    ...
    public sealed class ProxyDefinition : ProxyDefinitionBase
    {
        ...
        {
            var start = p;
            Delegate = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_core.crypto.AccountId32();
            Delegate.Decode(byteArray, ref p);
            ProxyType = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.kusama_runtime.EnumProxyType();
