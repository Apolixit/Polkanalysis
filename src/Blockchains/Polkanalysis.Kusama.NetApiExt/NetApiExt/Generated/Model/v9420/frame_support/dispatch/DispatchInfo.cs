...
{
    /// <summary>
    /// >> 891 - Composite[frame_support.dispatch.DispatchInfo]
    /// </summary>
    ...
    public sealed class DispatchInfo : DispatchInfoBase
    {
        ...
        {
            var start = p;
            Weight = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_weights.weight_v2.Weight();
            Weight.Decode(byteArray, ref p);
            Class = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.frame_support.dispatch.EnumDispatchClass();
