...
{
    /// <summary>
    /// >> 1372 - Composite[frame_support.dispatch.PerDispatchClassT2]
    /// </summary>
    ...
    public sealed class PerDispatchClassT2 : PerDispatchClassT2Base
    {
        ...
        {
            var start = p;
            Normal = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.frame_system.limits.WeightsPerClass();
            Normal.Decode(byteArray, ref p);
            Operational = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.frame_system.limits.WeightsPerClass();
            Operational.Decode(byteArray, ref p);
            Mandatory = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.frame_system.limits.WeightsPerClass();
