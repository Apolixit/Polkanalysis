...
{
    /// <summary>
    /// >> 877 - Composite[frame_support.dispatch.PerDispatchClassT1]
    /// </summary>
    ...
    public sealed class PerDispatchClassT1 : PerDispatchClassT1Base
    {
        ...
        {
            var start = p;
            Normal = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_weights.weight_v2.Weight();
            Normal.Decode(byteArray, ref p);
            Operational = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_weights.weight_v2.Weight();
            Operational.Decode(byteArray, ref p);
            Mandatory = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_weights.weight_v2.Weight();
