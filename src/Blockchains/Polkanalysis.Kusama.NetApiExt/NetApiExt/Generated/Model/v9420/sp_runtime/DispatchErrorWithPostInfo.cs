...
{
    /// <summary>
    /// >> 1326 - Composite[sp_runtime.DispatchErrorWithPostInfo]
    /// </summary>
    ...
    public sealed class DispatchErrorWithPostInfo : DispatchErrorWithPostInfoBase
    {
        ...
        {
            var start = p;
            PostInfo = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.frame_support.dispatch.PostDispatchInfo();
            PostInfo.Decode(byteArray, ref p);
            Error = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_runtime.EnumDispatchError();
