...
{
    /// <summary>
    /// >> 8637 - Composite[sp_consensus_slots.EquivocationProof]
    /// </summary>
    ...
    public sealed class EquivocationProof : EquivocationProofBase
    {
        ...
        {
            var start = p;
            Offender = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9280.sp_consensus_babe.app.Public();
            ...
            FirstHeader = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9280.sp_runtime.generic.header.Header();
            FirstHeader.Decode(byteArray, ref p);
            SecondHeader = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9280.sp_runtime.generic.header.Header();
