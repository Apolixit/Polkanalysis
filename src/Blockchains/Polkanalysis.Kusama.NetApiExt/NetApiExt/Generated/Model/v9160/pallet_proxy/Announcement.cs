...
{
    /// <summary>
    /// >> 16680 - Composite[pallet_proxy.Announcement]
    /// </summary>
    ...
    public sealed class Announcement : AnnouncementBase
    {
        ...
        {
            var start = p;
            Real = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9160.sp_core.crypto.AccountId32();
            Real.Decode(byteArray, ref p);
            CallHash = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9160.primitive_types.H256();
