...
{
    /// <summary>
    /// >> 4856 - Composite[pallet_staking.UnappliedSlash]
    /// </summary>
    ...
    public sealed class UnappliedSlash : UnappliedSlashBase
    {
        ...
        {
            var start = p;
            Validator = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_core.crypto.AccountId32();
            Validator.Decode(byteArray, ref p);
            Own = new Substrate.NetApi.Model.Types.Primitive.U128();
            Own.Decode(byteArray, ref p);
            Others = new Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_core.crypto.AccountId32, Substrate.NetApi.Model.Types.Primitive.U128>>();
            Others.Decode(byteArray, ref p);
            Reporters = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_core.crypto.AccountId32>();
