...
{
    /// <summary>
    /// >> 4930 - Composite[pallet_referenda.types.ReferendumStatusT1]
    /// </summary>
    ...
    public sealed class ReferendumStatusT1 : ReferendumStatusT1Base
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Origin = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.kusama_runtime.EnumOriginCaller();
            Origin.Decode(byteArray, ref p);
            Proposal = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.frame_support.traits.preimages.EnumBounded();
            Proposal.Decode(byteArray, ref p);
            Enactment = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.frame_support.traits.schedule.EnumDispatchTime();
            Enactment.Decode(byteArray, ref p);
            Submitted = new Substrate.NetApi.Model.Types.Primitive.U32();
            Submitted.Decode(byteArray, ref p);
            SubmissionDeposit = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_referenda.types.Deposit();
            SubmissionDeposit.Decode(byteArray, ref p);
            DecisionDeposit = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_referenda.types.Deposit>();
            DecisionDeposit.Decode(byteArray, ref p);
            Deciding = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_referenda.types.DecidingStatus>();
            Deciding.Decode(byteArray, ref p);
            Tally = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_conviction_voting.types.Tally();
