...
{
    /// <summary>
    /// >> 19777 - Composite[polkadot_parachain.primitives.HrmpChannelId]
    /// </summary>
    ...
    public sealed class HrmpChannelId : HrmpChannelIdBase
    {
        ...
        {
            var start = p;
            Sender = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_parachain.primitives.Id();
            Sender.Decode(byteArray, ref p);
            Recipient = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_parachain.primitives.Id();
