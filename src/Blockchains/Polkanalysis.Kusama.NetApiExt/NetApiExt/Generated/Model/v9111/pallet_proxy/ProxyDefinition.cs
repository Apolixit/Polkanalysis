...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.pallet_proxy
{
    /// <summary>
    /// >> 20259 - Composite[pallet_proxy.ProxyDefinition]
    /// </summary>
    ...
    public sealed class ProxyDefinition : ProxyDefinitionBase
    {
        ...
        {
            var start = p;
            Delegate = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.sp_core.crypto.AccountId32();
            Delegate.Decode(byteArray, ref p);
            ProxyType = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.kusama_runtime.EnumProxyType();
