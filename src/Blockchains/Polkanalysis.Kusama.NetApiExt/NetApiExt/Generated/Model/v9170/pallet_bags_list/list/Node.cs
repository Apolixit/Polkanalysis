...
{
    /// <summary>
    /// >> 15980 - Composite[pallet_bags_list.list.Node]
    /// </summary>
    ...
    public sealed class Node : NodeBase
    {
        ...
        {
            var start = p;
            Id = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.sp_core.crypto.AccountId32();
            Id.Decode(byteArray, ref p);
            Prev = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.sp_core.crypto.AccountId32>();
            Prev.Decode(byteArray, ref p);
            Next = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.sp_core.crypto.AccountId32>();
