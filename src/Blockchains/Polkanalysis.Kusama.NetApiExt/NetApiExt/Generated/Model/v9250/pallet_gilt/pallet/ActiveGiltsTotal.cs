...
{
    /// <summary>
    /// >> 11430 - Composite[pallet_gilt.pallet.ActiveGiltsTotal]
    /// </summary>
    ...
    public sealed class ActiveGiltsTotal : ActiveGiltsTotalBase
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Proportion = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9250.sp_arithmetic.per_things.Perquintill();
            Proportion.Decode(byteArray, ref p);
            Index = new Substrate.NetApi.Model.Types.Primitive.U32();
            Index.Decode(byteArray, ref p);
            Target = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9250.sp_arithmetic.per_things.Perquintill();
