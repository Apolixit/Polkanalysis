...
{
    /// <summary>
    /// >> 18983 - Composite[frame_system.EventRecord]
    /// </summary>
    ...
    public sealed class EventRecord : EventRecordBase
    {
        ...
        {
            var start = p;
            Phase = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.frame_system.EnumPhase();
            Phase.Decode(byteArray, ref p);
            Event1 = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.kusama_runtime.EnumEvent();
            Event1.Decode(byteArray, ref p);
            Topics = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.primitive_types.H256>();
