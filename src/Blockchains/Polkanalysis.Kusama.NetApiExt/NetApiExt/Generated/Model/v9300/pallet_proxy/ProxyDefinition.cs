...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.pallet_proxy
{
    /// <summary>
    /// >> 7495 - Composite[pallet_proxy.ProxyDefinition]
    /// </summary>
    ...
    public sealed class ProxyDefinition : ProxyDefinitionBase
    {
        ...
        {
            var start = p;
            Delegate = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.sp_core.crypto.AccountId32();
            Delegate.Decode(byteArray, ref p);
            ProxyType = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.kusama_runtime.EnumProxyType();
