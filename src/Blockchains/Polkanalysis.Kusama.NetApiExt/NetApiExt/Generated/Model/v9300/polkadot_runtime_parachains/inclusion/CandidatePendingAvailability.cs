...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_runtime_parachains.inclusion
{
    /// <summary>
    /// >> 7569 - Composite[polkadot_runtime_parachains.inclusion.CandidatePendingAvailability]
    /// </summary>
    ...
    public sealed class CandidatePendingAvailability : CandidatePendingAvailabilityBase
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Hash = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_core_primitives.CandidateHash();
            Hash.Decode(byteArray, ref p);
            Descriptor1 = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_primitives.v2.CandidateDescriptor();
            Descriptor1.Decode(byteArray, ref p);
            AvailabilityVotes = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.bitvec.order.Lsb0>();
            AvailabilityVotes.Decode(byteArray, ref p);
            Backers = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.bitvec.order.Lsb0>();
            ...
            BackingGroup1 = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_primitives.v2.GroupIndex();
