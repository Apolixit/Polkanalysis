...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9150.sp_runtime.generic.header
{
    /// <summary>
    /// >> 17711 - Composite[sp_runtime.generic.header.Header]
    /// </summary>
    ...
    public sealed class Header : HeaderBase
    {
        ...
        {
            var start = p;
            ParentHash = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9150.primitive_types.H256();
            ...
            StateRoot = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9150.primitive_types.H256();
            StateRoot.Decode(byteArray, ref p);
            ExtrinsicsRoot = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9150.primitive_types.H256();
            ExtrinsicsRoot.Decode(byteArray, ref p);
            Digest = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9150.sp_runtime.generic.digest.Digest();
