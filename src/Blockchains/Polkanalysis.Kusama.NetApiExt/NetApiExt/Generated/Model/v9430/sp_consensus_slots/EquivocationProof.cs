...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_consensus_slots
{
    ...
    public sealed class EquivocationProof : EquivocationProofBase
    {
        ...
        {
            var start = p;
            Offender = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_consensus_babe.app.Public();
            Offender.Decode(byteArray, ref p);
            Slot = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_consensus_slots.Slot();
            Slot.Decode(byteArray, ref p);
            FirstHeader = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_runtime.generic.header.Header();
            FirstHeader.Decode(byteArray, ref p);
            SecondHeader = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_runtime.generic.header.Header();
