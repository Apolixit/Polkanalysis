...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.pallet_proxy
{
    /// <summary>
    ...
    public sealed class ProxyDefinition : ProxyDefinitionBase
    {
        ...
        {
            var start = p;
            Delegate = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_core.crypto.AccountId32();
            Delegate.Decode(byteArray, ref p);
            ProxyType = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.kusama_runtime.EnumProxyType();
