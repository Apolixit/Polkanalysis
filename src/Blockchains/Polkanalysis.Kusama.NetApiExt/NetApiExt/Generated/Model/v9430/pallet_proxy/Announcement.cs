...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.pallet_proxy
{
    ...
    public sealed class Announcement : AnnouncementBase
    {
        ...
        {
            var start = p;
            Real = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_core.crypto.AccountId32();
            Real.Decode(byteArray, ref p);
            CallHash = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.primitive_types.H256();
