...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Model.v9151.pallet_proxy
{
    /// <summary>
    /// >> 17404 - Composite[pallet_proxy.ProxyDefinition]
    /// </summary>
    ...
    public sealed class ProxyDefinition : ProxyDefinitionBase
    {
        ...
        {
            var start = p;
            Delegate = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9151.sp_core.crypto.AccountId32();
            Delegate.Decode(byteArray, ref p);
            ProxyType = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9151.kusama_runtime.EnumProxyType();
