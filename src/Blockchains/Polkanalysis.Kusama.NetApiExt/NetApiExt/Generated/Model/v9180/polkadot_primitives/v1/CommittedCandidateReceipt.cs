...
{
    /// <summary>
    /// >> 15090 - Composite[polkadot_primitives.v1.CommittedCandidateReceipt]
    /// </summary>
    ...
    public sealed class CommittedCandidateReceipt : CommittedCandidateReceiptBase
    {
        ...
        {
            var start = p;
            Descriptor = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9180.polkadot_primitives.v1.CandidateDescriptor();
            Descriptor.Decode(byteArray, ref p);
            Commitments = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9180.polkadot_primitives.v1.CandidateCommitments();
