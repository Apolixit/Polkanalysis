...
{
    /// <summary>
    /// >> 15307 - Composite[polkadot_primitives.v1.DisputeState]
    /// </summary>
    ...
    public sealed class DisputeState : DisputeStateBase
    {
        ...
        {
            var start = p;
            ValidatorsFor = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9180.bitvec.order.Lsb0>();
            ValidatorsFor.Decode(byteArray, ref p);
            ValidatorsAgainst = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9180.bitvec.order.Lsb0>();
