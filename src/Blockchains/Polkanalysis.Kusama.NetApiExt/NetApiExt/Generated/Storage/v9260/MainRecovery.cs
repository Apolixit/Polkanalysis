...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9260
{
    public sealed class RecoveryStorage
    {
        ...
        /// </summary>
        public static string RecoverableParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The set of recoverable accounts and their recovery configuration.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_recovery.RecoveryConfig> Recoverable(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = RecoverableParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_recovery.RecoveryConfig>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ActiveRecoveriesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  is the user trying to recover the account.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_recovery.ActiveRecovery> ActiveRecoveries(Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32> key, CancellationToken token)
        {
            string parameters = ActiveRecoveriesParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_recovery.ActiveRecovery>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ProxyParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Map from the user who can access it to the recovered account.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32> Proxy(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
