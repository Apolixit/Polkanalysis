...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9260
{
    public sealed class DemocracyStorage
    {
        ...
        ///  TWOX-NOTE: Safe, as increasing integer keys are safe.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32>, Substrate.NetApi.Model.Types.Primitive.U128>> DepositOf(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = DepositOfParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32>, Substrate.NetApi.Model.Types.Primitive.U128>>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string PreimagesParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.primitive_types.H256 key)
        {
        ...
        ///  The block number is the block at which it was deposited.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.EnumPreimageStatus> Preimages(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = PreimagesParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.EnumPreimageStatus>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  TWOX-NOTE: SAFE as indexes are not under an attacker���s control.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.types.EnumReferendumInfo> ReferendumInfoOf(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = ReferendumInfoOfParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.types.EnumReferendumInfo>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string VotingOfParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  TWOX-NOTE: SAFE as `AccountId`s are crypto hashes anyway.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.vote.EnumVoting> VotingOf(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = VotingOfParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.vote.EnumVoting>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  - `PublicProps` is empty.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.primitive_types.H256, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.vote_threshold.EnumVoteThreshold>> NextExternal(CancellationToken token)
        {
            string parameters = NextExternalParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.primitive_types.H256, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.vote_threshold.EnumVoteThreshold>>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string BlacklistParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.primitive_types.H256 key)
        {
        ...
        ///  (until when it may not be resubmitted) and who vetoed it.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32>>> Blacklist(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = BlacklistParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32>>>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string CancellationsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.primitive_types.H256 key)
        {
        ...
        ///  Record of all proposals that have been subject to emergency cancellation.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.Bool> Cancellations(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.primitive_types.H256 key, CancellationToken token)
        {
        ...
        ///  New networks start with last version.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.EnumReleases> StorageVersion(CancellationToken token)
        {
            string parameters = StorageVersionParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9260.pallet_democracy.EnumReleases>(parameters, blockHash, token);
            return result;
        }
