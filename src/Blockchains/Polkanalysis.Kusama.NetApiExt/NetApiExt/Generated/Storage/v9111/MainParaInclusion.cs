...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9111
{
    public sealed class ParaInclusionStorage
    {
        ...
        /// </summary>
        public static string AvailabilityBitfieldsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_primitives.v0.ValidatorIndex key)
        {
        ...
        ///  The latest bitfield for each validator, referred to by their index in the validator set.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_runtime_parachains.inclusion.AvailabilityBitfieldRecord> AvailabilityBitfields(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_primitives.v0.ValidatorIndex key, CancellationToken token)
        {
            string parameters = AvailabilityBitfieldsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_runtime_parachains.inclusion.AvailabilityBitfieldRecord>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string PendingAvailabilityParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_parachain.primitives.Id key)
        {
        ...
        ///  Candidates pending availability by `ParaId`.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_runtime_parachains.inclusion.CandidatePendingAvailability> PendingAvailability(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_parachain.primitives.Id key, CancellationToken token)
        {
            string parameters = PendingAvailabilityParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_runtime_parachains.inclusion.CandidatePendingAvailability>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string PendingAvailabilityCommitmentsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_parachain.primitives.Id key)
        {
        ...
        ///  The commitments of candidates pending availability, by `ParaId`.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_primitives.v1.CandidateCommitments> PendingAvailabilityCommitments(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_parachain.primitives.Id key, CancellationToken token)
        {
            string parameters = PendingAvailabilityCommitmentsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9111.polkadot_primitives.v1.CandidateCommitments>(parameters, blockHash, token);
            return result;
        }
