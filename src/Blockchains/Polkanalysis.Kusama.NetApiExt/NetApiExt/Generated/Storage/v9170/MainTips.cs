...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9170
{
    public sealed class TipsStorage
    {
        ...
        /// </summary>
        public static string TipsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.primitive_types.H256 key)
        {
        ...
        ///  guaranteed to be a secure hash.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.pallet_tips.OpenTip> Tips(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = TipsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.pallet_tips.OpenTip>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ReasonsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.primitive_types.H256 key)
        {
        ...
        ///  insecure enumerable hash since the key is guaranteed to be the result of a secure hash.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> Reasons(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.primitive_types.H256 key, CancellationToken token)
        {
    ...
    public sealed class TipsConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.sp_arithmetic.per_things.Percent TipFindersFee()
        {
            var result = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.sp_arithmetic.per_things.Percent();
            result.Create("0x14");
            return result;
        }
