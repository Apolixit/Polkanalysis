...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9170
{
    public sealed class ParaSessionInfoStorage
    {
        ...
        ///  When in doubt, use `Sessions` API instead.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.polkadot_primitives.v1.assignment_app.Public>> AssignmentKeysUnsafe(CancellationToken token)
        {
            string parameters = AssignmentKeysUnsafeParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.polkadot_primitives.v1.assignment_app.Public>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Does not have any entries before the session index in the first session change notification.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.polkadot_primitives.v2.SessionInfo> Sessions(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = SessionsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.polkadot_primitives.v2.SessionInfo>(parameters, blockHash, token);
            return result;
        }
