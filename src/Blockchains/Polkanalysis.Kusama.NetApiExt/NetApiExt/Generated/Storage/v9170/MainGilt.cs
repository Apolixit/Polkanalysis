...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9170
{
    public sealed class GiltStorage
    {
        ...
        ///  The queues of bids ready to become gilts. Indexed by duration (in `Period`s).
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.pallet_gilt.pallet.GiltBid>> Queues(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = QueuesParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.pallet_gilt.pallet.GiltBid>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Information relating to the gilts currently active.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.pallet_gilt.pallet.ActiveGiltsTotal> ActiveTotal(CancellationToken token)
        {
            string parameters = ActiveTotalParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.pallet_gilt.pallet.ActiveGiltsTotal>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  The currently active gilts, indexed according to the order of creation.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.pallet_gilt.pallet.ActiveGilt> Active(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = ActiveParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9170.pallet_gilt.pallet.ActiveGilt>(parameters, blockHash, token);
            return result;
        }
