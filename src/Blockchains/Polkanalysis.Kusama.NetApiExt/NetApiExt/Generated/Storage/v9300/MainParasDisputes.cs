...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9300
{
    public sealed class ParasDisputesStorage
    {
        ...
        /// </summary>
        public static string DisputesParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_core_primitives.CandidateHash> key)
        {
        ...
        ///  All ongoing or concluded disputes for the last several sessions.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_primitives.v2.DisputeState> Disputes(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_core_primitives.CandidateHash> key, CancellationToken token)
        {
            string parameters = DisputesParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_primitives.v2.DisputeState>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string IncludedParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_core_primitives.CandidateHash> key)
        {
        ...
        ///  should be reverted back to if the candidate is disputed and determined to be invalid.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> Included(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_core_primitives.CandidateHash> key, CancellationToken token)
        {
