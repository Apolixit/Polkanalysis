...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9300
{
    public sealed class ParaInherentStorage
    {
        ...
        ///  Scraped on chain data for extracting resolved disputes as well as backing votes.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_primitives.v2.ScrapedOnChainVotes> OnChainVotes(CancellationToken token)
        {
            string parameters = OnChainVotesParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9300.polkadot_primitives.v2.ScrapedOnChainVotes>(parameters, blockHash, token);
            return result;
        }
