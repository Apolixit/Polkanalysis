...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9350
{
    public sealed class BabeStorage
    {
        ...
        ///  Current epoch authorities.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.app.Public, Substrate.NetApi.Model.Types.Primitive.U64>>> Authorities(CancellationToken token)
        {
            string parameters = AuthoritiesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.app.Public, Substrate.NetApi.Model.Types.Primitive.U64>>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  until the first block of the chain.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_slots.Slot> GenesisSlot(CancellationToken token)
        {
            string parameters = GenesisSlotParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_slots.Slot>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Current slot number.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_slots.Slot> CurrentSlot(CancellationToken token)
        {
        ...
        ///  Pending epoch configuration change that will be applied when the next epoch is enacted.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.digests.EnumNextConfigDescriptor> PendingEpochConfigChange(CancellationToken token)
        {
            string parameters = PendingEpochConfigChangeParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.digests.EnumNextConfigDescriptor>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Next epoch authorities.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.app.Public, Substrate.NetApi.Model.Types.Primitive.U64>>> NextAuthorities(CancellationToken token)
        {
        ...
        ///  if per-block initialization has already been called for current block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.digests.EnumPreDigest>> Initialized(CancellationToken token)
        {
            string parameters = InitializedParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.digests.EnumPreDigest>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  genesis.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.BabeEpochConfiguration> EpochConfig(CancellationToken token)
        {
            string parameters = EpochConfigParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.BabeEpochConfiguration>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  (you can fallback to `EpochConfig` instead in that case).
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_consensus_babe.BabeEpochConfiguration> NextEpochConfig(CancellationToken token)
        {
