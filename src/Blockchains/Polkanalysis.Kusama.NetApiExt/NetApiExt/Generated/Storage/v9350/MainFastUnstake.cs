...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9350
{
    public sealed class FastUnstakeStorage
    {
        ...
        ///  The current "head of the queue" being unstaked.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_fast_unstake.types.UnstakeRequest> Head(CancellationToken token)
        {
            string parameters = HeadParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_fast_unstake.types.UnstakeRequest>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string QueueParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Keeps track of `AccountId` wishing to unstake and it's corresponding deposit.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> Queue(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
