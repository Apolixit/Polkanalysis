...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9350
{
    public sealed class TechnicalCommitteeStorage
    {
        ...
        ///  The hashes of the active proposals.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.primitive_types.H256>> Proposals(CancellationToken token)
        {
            string parameters = ProposalsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.primitive_types.H256>>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ProposalOfParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.primitive_types.H256 key)
        {
        ...
        ///  Actual proposal for a given hash, if it's current.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.kusama_runtime.EnumRuntimeCall> ProposalOf(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = ProposalOfParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.kusama_runtime.EnumRuntimeCall>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string VotingParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.primitive_types.H256 key)
        {
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_collective.Votes> Voting(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = VotingParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_collective.Votes>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  The prime member that helps determine the default vote behavior in case of absentations.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_core.crypto.AccountId32> Prime(CancellationToken token)
        {
