...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9350
{
    public sealed class GrandpaStorage
    {
        ...
        ///  State of the current authority set.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_grandpa.EnumStoredState> State(CancellationToken token)
        {
            string parameters = StateParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_grandpa.EnumStoredState>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Pending change: (signaled at, scheduled change).
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_grandpa.StoredPendingChange> PendingChange(CancellationToken token)
        {
            string parameters = PendingChangeParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_grandpa.StoredPendingChange>(parameters, blockHash, token);
            return result;
        }
