...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9350
{
    public sealed class XcmPalletStorage
    {
        ...
        ///  The ongoing queries.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_xcm.pallet.EnumQueryStatus> Queries(Substrate.NetApi.Model.Types.Primitive.U64 key, CancellationToken token)
        {
            string parameters = QueriesParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_xcm.pallet.EnumQueryStatus>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string AssetTrapsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.primitive_types.H256 key)
        {
        ...
        ///  times this pair has been trapped (usually just 1 if it exists at all).
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> AssetTraps(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.primitive_types.H256 key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string SupportedVersionParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.xcm.EnumVersionedMultiLocation> key)
        {
        ...
        ///  The Latest versions that we know various locations support.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> SupportedVersion(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.xcm.EnumVersionedMultiLocation> key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VersionNotifiersParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.xcm.EnumVersionedMultiLocation> key)
        {
        ...
        ///  All locations that we have requested version notifications from.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U64> VersionNotifiers(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.xcm.EnumVersionedMultiLocation> key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VersionNotifyTargetsParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.xcm.EnumVersionedMultiLocation> key)
        {
        ...
        ///  which is used as a prioritization.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.xcm.EnumVersionedMultiLocation, Substrate.NetApi.Model.Types.Primitive.U32>>> VersionDiscoveryQueue(CancellationToken token)
        {
            string parameters = VersionDiscoveryQueueParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.xcm.EnumVersionedMultiLocation, Substrate.NetApi.Model.Types.Primitive.U32>>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  The current migration's stage, if any.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_xcm.pallet.EnumVersionMigrationStage> CurrentMigration(CancellationToken token)
        {
            string parameters = CurrentMigrationParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_xcm.pallet.EnumVersionMigrationStage>(parameters, blockHash, token);
            return result;
        }
