...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9350
{
    public sealed class AuthorshipStorage
    {
        ...
        ///  Uncles
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_authorship.EnumUncleEntryItem>> Uncles(CancellationToken token)
        {
            string parameters = UnclesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.pallet_authorship.EnumUncleEntryItem>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9350.sp_core.crypto.AccountId32> Author(CancellationToken token)
        {
