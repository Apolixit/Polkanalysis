...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9430
{
    public sealed class ClaimsStorage
    {
        ...
        /// >> ClaimsParams
        /// </summary>
        public static string ClaimsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EthereumAddress key)
        {
        ...
        /// >> Claims
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> Claims(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EthereumAddress key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VestingParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EthereumAddress key)
        {
        ...
        ///  The block number is when the vesting should start.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U128, Substrate.NetApi.Model.Types.Primitive.U32>> Vesting(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EthereumAddress key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string SigningParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EthereumAddress key)
        {
        ...
        ///  The statement kind that must be signed, if any.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EnumStatementKind> Signing(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EthereumAddress key, CancellationToken token)
        {
            string parameters = SigningParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EnumStatementKind>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string PreclaimsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Pre-claimed Ethereum accounts, by the Account ID that they are claimed to.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EthereumAddress> Preclaims(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = PreclaimsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_runtime_common.claims.EthereumAddress>(parameters, blockHash, token);
            return result;
        }
