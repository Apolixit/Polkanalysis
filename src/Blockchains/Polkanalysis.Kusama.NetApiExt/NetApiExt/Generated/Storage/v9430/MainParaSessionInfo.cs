...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9430
{
    public sealed class ParaSessionInfoStorage
    {
        ...
        ///  When in doubt, use `Sessions` API instead.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.assignment_app.Public>> AssignmentKeysUnsafe(CancellationToken token)
        {
            string parameters = AssignmentKeysUnsafeParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.assignment_app.Public>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Does not have any entries before the session index in the first session change notification.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.SessionInfo> Sessions(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = SessionsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.SessionInfo>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  The validator account keys of the validators actively participating in parachain consensus.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.sp_core.crypto.AccountId32>> AccountKeys(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
        ...
        ///  Executor parameter set for a given session index
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.executor_params.ExecutorParams> SessionExecutorParams(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = SessionExecutorParamsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.executor_params.ExecutorParams>(parameters, blockHash, token);
            return result;
        }
