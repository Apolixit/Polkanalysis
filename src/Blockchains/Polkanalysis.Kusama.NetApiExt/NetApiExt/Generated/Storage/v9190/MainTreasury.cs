...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9190
{
    public sealed class TreasuryStorage
    {
        ...
        ///  Proposals that have been made.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.pallet_treasury.Proposal> Proposals(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = ProposalsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.pallet_treasury.Proposal>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class TreasuryConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.sp_arithmetic.per_things.Permill ProposalBond()
        {
            var result = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.sp_arithmetic.per_things.Permill();
        ...
        public Substrate.NetApi.Model.Types.Primitive.U128 ProposalBondMinimum()
        {
            ...
            result.Create("0x1098A4850F0000000000000000000000");
            return result;
        }
        ...
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.NetApi.Model.Types.Primitive.U128> ProposalBondMaximum()
        {
            ...
            result.Create("0x0120B3251A080300000000000000000000");
            return result;
        }
        ...
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.sp_arithmetic.per_things.Permill Burn()
        {
            var result = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9190.sp_arithmetic.per_things.Permill();
