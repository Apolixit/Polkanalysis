...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9130
{
    public sealed class DmpStorage
    {
        ...
        /// </summary>
        public static string DownwardMessageQueuesParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9130.polkadot_parachain.primitives.Id key)
        {
        ...
        ///  The downward messages addressed for a certain para.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9130.polkadot_core_primitives.InboundDownwardMessage>> DownwardMessageQueues(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9130.polkadot_parachain.primitives.Id key, CancellationToken token)
        {
            string parameters = DownwardMessageQueuesParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9130.polkadot_core_primitives.InboundDownwardMessage>>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string DownwardMessageQueueHeadsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9130.polkadot_parachain.primitives.Id key)
        {
        ...
        ///  - `H(M)`: is the hash of the message being appended.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9130.primitive_types.H256> DownwardMessageQueueHeads(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9130.polkadot_parachain.primitives.Id key, CancellationToken token)
        {
