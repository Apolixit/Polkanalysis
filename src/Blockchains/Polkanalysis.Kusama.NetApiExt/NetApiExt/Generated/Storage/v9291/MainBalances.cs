...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9291
{
    public sealed class BalancesStorage
    {
        ...
        ///  NOTE: This is only used in the case that this pallet is used to store balances.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.pallet_balances.AccountData> Account(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = AccountParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.pallet_balances.AccountData>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string LocksParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  NOTE: Should only be accessed when setting, changing and freeing a lock.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.pallet_balances.BalanceLock>> Locks(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = LocksParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.pallet_balances.BalanceLock>>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ReservesParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Named reserves on some account balances.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.pallet_balances.ReserveData>> Reserves(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = ReservesParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.pallet_balances.ReserveData>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  This is set to v2.0.0 for new networks.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.pallet_balances.EnumReleases> StorageVersion(CancellationToken token)
        {
            string parameters = StorageVersionParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9291.pallet_balances.EnumReleases>(parameters, blockHash, token);
            return result;
        }
