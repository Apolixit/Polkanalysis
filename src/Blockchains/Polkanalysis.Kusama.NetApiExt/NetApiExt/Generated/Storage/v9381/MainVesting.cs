...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9381
{
    public sealed class VestingStorage
    {
        ...
        /// </summary>
        public static string VestingParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9381.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Information regarding the vesting of a given account.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9381.pallet_vesting.vesting_info.VestingInfo>> Vesting(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9381.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = VestingParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9381.pallet_vesting.vesting_info.VestingInfo>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  New networks start with latest version, as determined by the genesis build.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9381.pallet_vesting.EnumReleases> StorageVersion(CancellationToken token)
        {
            string parameters = StorageVersionParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9381.pallet_vesting.EnumReleases>(parameters, blockHash, token);
            return result;
        }
