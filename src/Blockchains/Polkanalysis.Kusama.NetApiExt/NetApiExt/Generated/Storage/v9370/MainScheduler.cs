...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9370
{
    public sealed class SchedulerStorage
    {
        ...
        ///  Items to be executed, indexed by the block number that they should be executed on.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9370.pallet_scheduler.Scheduled>>> Agenda(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = AgendaParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9370.pallet_scheduler.Scheduled>>>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class SchedulerConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9370.sp_weights.weight_v2.Weight MaximumWeight()
        {
