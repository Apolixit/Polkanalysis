...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9340
{
    public sealed class ElectionProviderMultiPhaseStorage
    {
        ...
        ///  Current phase.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.EnumPhase> CurrentPhase(CancellationToken token)
        {
            string parameters = CurrentPhaseParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.EnumPhase>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Current best solution, signed or unsigned, queued to be returned upon `elect`.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.ReadySolution> QueuedSolution(CancellationToken token)
        {
            string parameters = QueuedSolutionParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.ReadySolution>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  This is created at the beginning of the signed phase and cleared upon calling `elect`.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.RoundSnapshot> Snapshot(CancellationToken token)
        {
            string parameters = SnapshotParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.RoundSnapshot>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Only exists when [`Snapshot`] is present.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.SolutionOrSnapshotSize> SnapshotMetadata(CancellationToken token)
        {
            string parameters = SnapshotMetadataParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.SolutionOrSnapshotSize>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  them one at a time instead of reading and decoding all of them at once.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_npos_elections.ElectionScore, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>> SignedSubmissionIndices(CancellationToken token)
        {
            string parameters = SignedSubmissionIndicesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_npos_elections.ElectionScore, Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  affect; we shouldn't need a cryptographically secure hasher.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.signed.SignedSubmission> SignedSubmissionsMap(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = SignedSubmissionsMapParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.pallet_election_provider_multi_phase.signed.SignedSubmission>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Can be set via `set_minimum_untrusted_score`.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_npos_elections.ElectionScore> MinimumUntrustedScore(CancellationToken token)
        {
            string parameters = MinimumUntrustedScoreParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_npos_elections.ElectionScore>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class ElectionProviderMultiPhaseConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_arithmetic.per_things.Perbill BetterSignedThreshold()
        {
            var result = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_arithmetic.per_things.Perbill();
        ...
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_arithmetic.per_things.Perbill BetterUnsignedThreshold()
        {
            var result = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_arithmetic.per_things.Perbill();
        ...
        ///  this value.
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_weights.weight_v2.Weight SignedMaxWeight()
        {
            var result = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_weights.weight_v2.Weight();
            result.Create("0x0B7037A3205701CECCEC00");
            return result;
        }
        ...
        /// >> MinerMaxWeight
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_weights.weight_v2.Weight MinerMaxWeight()
        {
            var result = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9340.sp_weights.weight_v2.Weight();
            result.Create("0x0B7037A3205701CECCEC00");
            return result;
