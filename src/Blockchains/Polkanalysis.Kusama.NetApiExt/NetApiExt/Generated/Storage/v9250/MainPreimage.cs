...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9250
{
    public sealed class PreimageStorage
    {
        ...
        /// </summary>
        public static string StatusForParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9250.primitive_types.H256 key)
        {
        ...
        ///  The request status of a given hash.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9250.pallet_preimage.EnumRequestStatus> StatusFor(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9250.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = StatusForParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9250.pallet_preimage.EnumRequestStatus>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string PreimageForParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9250.primitive_types.H256 key)
        {
        ...
        ///  The preimages stored by this pallet.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> PreimageFor(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9250.primitive_types.H256 key, CancellationToken token)
        {
