...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9420
{
    public sealed class ChildBountiesStorage
    {
        ...
        ///  Child bounties that have been added.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_child_bounties.ChildBounty> ChildBounties(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32> key, CancellationToken token)
        {
            string parameters = ChildBountiesParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_child_bounties.ChildBounty>(parameters, blockHash, token);
            return result;
        }
