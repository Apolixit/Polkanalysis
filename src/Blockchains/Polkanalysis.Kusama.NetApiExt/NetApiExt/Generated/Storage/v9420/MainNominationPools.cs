...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9420
{
    public sealed class NominationPoolsStorage
    {
        ...
        ///  `GlobalMaxCommission` is lower than some current pool commissions.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_arithmetic.per_things.Perbill> GlobalMaxCommission(CancellationToken token)
        {
        ...
        /// </summary>
        public static string PoolMembersParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  TWOX-NOTE: SAFE since `AccountId` is a secure hash.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.PoolMember> PoolMembers(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = PoolMembersParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.PoolMember>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Storage for bonded pools.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.BondedPoolInner> BondedPools(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = BondedPoolsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.BondedPoolInner>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  claimed, the balance comes out fo the reward pool. Keyed by the bonded pools account.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.RewardPool> RewardPools(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = RewardPoolsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.RewardPool>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  bonded pool, hence the name sub-pools. Keyed by the bonded pools account.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.SubPools> SubPoolsStorage(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = SubPoolsStorageParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.SubPools>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ReversePoolIdLookupParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  accounts are deterministically derived from it.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> ReversePoolIdLookup(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string ClaimPermissionsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Map from a pool member account to their opted claim permission.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.EnumClaimPermission> ClaimPermissions(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = ClaimPermissionsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_nomination_pools.EnumClaimPermission>(parameters, blockHash, token);
            return result;
        }
