...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9420
{
    public sealed class BalancesStorage
    {
        ...
        ///  Holds on account balances.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_balances.types.IdAmountT1>> Holds(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = HoldsParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9420.pallet_balances.types.IdAmountT1>>(parameters, blockHash, token);
            return result;
        }
