...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9122
{
    public sealed class OffencesStorage
    {
        ...
        /// </summary>
        public static string ReportsParams(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.primitive_types.H256 key)
        {
        ...
        ///  The primary structure that holds all offence records keyed by report identifiers.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.sp_staking.offence.OffenceDetails> Reports(Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = ReportsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.sp_staking.offence.OffenceDetails>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  A vector of reports of the same kind that happened at the same time slot.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.primitive_types.H256>> ConcurrentReportsIndex(Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Kusama.NetApiExt.Generated.Types.Base.Arr16U8, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key, CancellationToken token)
        {
