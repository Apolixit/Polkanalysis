...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9122
{
    public sealed class TreasuryStorage
    {
        ...
        ///  Proposals that have been made.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.pallet_treasury.Proposal> Proposals(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = ProposalsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.pallet_treasury.Proposal>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class TreasuryConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.sp_arithmetic.per_things.Permill ProposalBond()
        {
            var result = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.sp_arithmetic.per_things.Permill();
        ...
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.sp_arithmetic.per_things.Permill Burn()
        {
            var result = new Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.sp_arithmetic.per_things.Permill();
