...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9122
{
    public sealed class ParasSharedStorage
    {
        ...
        ///  Indices are into the broader validator set.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.polkadot_primitives.v0.ValidatorIndex>> ActiveValidatorIndices(CancellationToken token)
        {
            string parameters = ActiveValidatorIndicesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.polkadot_primitives.v0.ValidatorIndex>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  This should be the same length as `ActiveValidatorIndices`.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.polkadot_primitives.v0.validator_app.Public>> ActiveValidatorKeys(CancellationToken token)
        {
            string parameters = ActiveValidatorKeysParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.polkadot_primitives.v0.validator_app.Public>>(parameters, blockHash, token);
            return result;
        }
