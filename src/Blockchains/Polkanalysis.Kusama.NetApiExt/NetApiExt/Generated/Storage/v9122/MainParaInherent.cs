...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9122
{
    public sealed class ParaInherentStorage
    {
        ...
        ///  Scraped on chain data for extracting resolved disputes as well as backing votes.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.polkadot_primitives.v1.ScrapedOnChainVotes> OnChainVotes(CancellationToken token)
        {
            string parameters = OnChainVotesParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9122.polkadot_primitives.v1.ScrapedOnChainVotes>(parameters, blockHash, token);
            return result;
        }
