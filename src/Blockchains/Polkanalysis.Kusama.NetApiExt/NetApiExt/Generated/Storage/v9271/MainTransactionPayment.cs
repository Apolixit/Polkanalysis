...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9271
{
    public sealed class TransactionPaymentStorage
    {
        ...
        /// >> NextFeeMultiplier
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9271.sp_arithmetic.fixed_point.FixedU128> NextFeeMultiplier(CancellationToken token)
        {
            string parameters = NextFeeMultiplierParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9271.sp_arithmetic.fixed_point.FixedU128>(parameters, blockHash, token);
            return result;
        }
        ...
        /// >> StorageVersion
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9271.pallet_transaction_payment.EnumReleases> StorageVersion(CancellationToken token)
        {
            string parameters = StorageVersionParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9271.pallet_transaction_payment.EnumReleases>(parameters, blockHash, token);
            return result;
        }
