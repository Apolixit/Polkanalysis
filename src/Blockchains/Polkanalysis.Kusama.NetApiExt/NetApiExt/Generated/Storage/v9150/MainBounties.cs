...
namespace Polkanalysis.Kusama.NetApiExt.Generated.Storage.v9150
{
    public sealed class BountiesStorage
    {
        ...
        ///  Bounties that have been made.
        /// </summary>
        public async Task<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9150.pallet_bounties.Bounty> Bounties(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = BountiesParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Kusama.NetApiExt.Generated.Model.v9150.pallet_bounties.Bounty>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class BountiesConstants
    {
        ...
        ///  curator.
        /// </summary>
        public Polkanalysis.Kusama.NetApiExt.Generated.Model.v9150.sp_arithmetic.per_things.Permill BountyCuratorDeposit()
        {
