...
{
    /// <summary>
    /// >> 15342 - Composite[pallet_referenda.types.ReferendumStatus]
    /// </summary>
    ...
    public sealed class ReferendumStatus : ReferendumStatusBase
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Origin = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.polkadot_runtime.EnumOriginCaller();
            Origin.Decode(byteArray, ref p);
            Proposal = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.frame_support.traits.preimages.EnumBounded();
            Proposal.Decode(byteArray, ref p);
            Enactment = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.frame_support.traits.schedule.EnumDispatchTime();
            Enactment.Decode(byteArray, ref p);
            Submitted = new Substrate.NetApi.Model.Types.Primitive.U32();
            Submitted.Decode(byteArray, ref p);
            SubmissionDeposit = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.pallet_referenda.types.Deposit();
            SubmissionDeposit.Decode(byteArray, ref p);
            DecisionDeposit = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.pallet_referenda.types.Deposit>();
            DecisionDeposit.Decode(byteArray, ref p);
            Deciding = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.pallet_referenda.types.DecidingStatus>();
            Deciding.Decode(byteArray, ref p);
            Tally = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.pallet_conviction_voting.types.Tally();
