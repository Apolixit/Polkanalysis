...
{
    /// <summary>
    /// >> 8626 - Composite[pallet_proxy.Announcement]
    /// </summary>
    ...
    public sealed class Announcement : AnnouncementBase
    {
        ...
        {
            var start = p;
            Real = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9270.sp_core.crypto.AccountId32();
            Real.Decode(byteArray, ref p);
            CallHash = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9270.primitive_types.H256();
