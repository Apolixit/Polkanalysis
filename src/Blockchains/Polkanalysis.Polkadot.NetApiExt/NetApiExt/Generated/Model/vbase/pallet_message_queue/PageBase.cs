...
{
    /// <summary>
    /// >> 15996 - Composite[pallet_message_queue.PageBase]
    /// </summary>
    ...
    public abstract class PageBase : BaseType
    {
        ...
        public static Polkanalysis.Polkadot.NetApiExt.Generated.Model.vbase.pallet_message_queue.PageBase Create(byte[] data, uint version)
        {
            Polkanalysis.Polkadot.NetApiExt.Generated.Model.vbase.pallet_message_queue.PageBase instance = null;
            if (version == 9430U)
            {
                instance = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.pallet_message_queue.Page();
