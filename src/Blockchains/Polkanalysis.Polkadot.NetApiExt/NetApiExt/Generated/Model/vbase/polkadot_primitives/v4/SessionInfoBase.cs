...
{
    /// <summary>
    /// >> 15982 - Composite[polkadot_primitives.v4.SessionInfoBase]
    /// </summary>
    ...
    public abstract class SessionInfoBase : BaseType
    {
        ...
        public static Polkanalysis.Polkadot.NetApiExt.Generated.Model.vbase.polkadot_primitives.v4.SessionInfoBase Create(byte[] data, uint version)
        {
            Polkanalysis.Polkadot.NetApiExt.Generated.Model.vbase.polkadot_primitives.v4.SessionInfoBase instance = null;
            if (version == 9420U)
            {
                instance = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9420.polkadot_primitives.v4.SessionInfo();
                instance.Create(data);
            }

            if (version == 9430U)
            {
                instance = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.SessionInfo();
                instance.Create(data);
            }
