...
{
    /// <summary>
    /// >> 15961 - Composite[pallet_referenda.types.TrackInfoBase]
    /// </summary>
    ...
    public abstract class TrackInfoBase : BaseType
    {
        ...
        public static Polkanalysis.Polkadot.NetApiExt.Generated.Model.vbase.pallet_referenda.types.TrackInfoBase Create(byte[] data, uint version)
        {
            Polkanalysis.Polkadot.NetApiExt.Generated.Model.vbase.pallet_referenda.types.TrackInfoBase instance = null;
            if (version == 9420U)
            {
                instance = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9420.pallet_referenda.types.TrackInfo();
                instance.Create(data);
            }

            if (version == 9430U)
            {
                instance = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.pallet_referenda.types.TrackInfo();
                instance.Create(data);
            }
