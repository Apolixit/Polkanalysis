...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.pallet_democracy.types
{
    /// <summary>
    /// >> 5771 - Composite[pallet_democracy.types.ReferendumStatus]
    /// </summary>
    ...
    public sealed class ReferendumStatus : ReferendumStatusBase
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            ProposalHash = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.primitive_types.H256();
            ProposalHash.Decode(byteArray, ref p);
            Threshold = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.pallet_democracy.vote_threshold.EnumVoteThreshold();
            Threshold.Decode(byteArray, ref p);
            Delay = new Substrate.NetApi.Model.Types.Primitive.U32();
            Delay.Decode(byteArray, ref p);
            Tally = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.pallet_democracy.types.Tally();
