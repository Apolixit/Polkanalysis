...
{
    /// <summary>
    /// >> 4239 - Composite[polkadot_primitives.v2.CommittedCandidateReceipt]
    /// </summary>
    ...
    public sealed class CommittedCandidateReceipt : CommittedCandidateReceiptBase
    {
        ...
        {
            var start = p;
            Descriptor = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9190.polkadot_primitives.v2.CandidateDescriptor();
            Descriptor.Decode(byteArray, ref p);
            Commitments = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9190.polkadot_primitives.v2.CandidateCommitments();
