...
{
    /// <summary>
    /// >> 4486 - Composite[polkadot_runtime_parachains.paras.PvfCheckActiveVoteState]
    /// </summary>
    ...
    public sealed class PvfCheckActiveVoteState : PvfCheckActiveVoteStateBase
    {
        ...
        {
            var start = p;
            VotesAccept = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9190.bitvec.order.Lsb0>();
            VotesAccept.Decode(byteArray, ref p);
            VotesReject = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9190.bitvec.order.Lsb0>();
            ...
            Causes = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9190.polkadot_runtime_parachains.paras.EnumPvfCheckCause>();
