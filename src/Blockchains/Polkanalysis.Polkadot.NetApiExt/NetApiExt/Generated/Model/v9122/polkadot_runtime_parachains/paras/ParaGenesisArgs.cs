...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.polkadot_runtime_parachains.paras
{
    /// <summary>
    /// >> 1129 - Composite[polkadot_runtime_parachains.paras.ParaGenesisArgs]
    /// </summary>
    ...
    public sealed class ParaGenesisArgs : ParaGenesisArgsBase
    {
        ...
        {
            var start = p;
            GenesisHead = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.polkadot_parachain.primitives.HeadData();
            GenesisHead.Decode(byteArray, ref p);
            ValidationCode = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.polkadot_parachain.primitives.ValidationCode();
