...
{
    /// <summary>
    /// >> 2578 - Composite[polkadot_primitives.v1.CandidateDescriptor]
    /// </summary>
    ...
    public sealed class CandidateDescriptor : CandidateDescriptorBase
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            RelayParent = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.primitive_types.H256();
            RelayParent.Decode(byteArray, ref p);
            Collator = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.polkadot_primitives.v0.collator_app.Public();
            Collator.Decode(byteArray, ref p);
            PersistedValidationDataHash = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.primitive_types.H256();
            PersistedValidationDataHash.Decode(byteArray, ref p);
            PovHash = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.primitive_types.H256();
            PovHash.Decode(byteArray, ref p);
            ErasureRoot = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.primitive_types.H256();
            ErasureRoot.Decode(byteArray, ref p);
            Signature = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.polkadot_primitives.v0.collator_app.Signature();
            Signature.Decode(byteArray, ref p);
            ParaHead = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.primitive_types.H256();
            ParaHead.Decode(byteArray, ref p);
            ValidationCodeHash = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.polkadot_parachain.primitives.ValidationCodeHash();
