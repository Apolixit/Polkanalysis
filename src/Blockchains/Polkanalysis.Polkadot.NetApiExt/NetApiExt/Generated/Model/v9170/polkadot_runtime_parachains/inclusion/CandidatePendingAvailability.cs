...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.polkadot_runtime_parachains.inclusion
{
    /// <summary>
    /// >> 3082 - Composite[polkadot_runtime_parachains.inclusion.CandidatePendingAvailability]
    /// </summary>
    ...
    public sealed class CandidatePendingAvailability : CandidatePendingAvailabilityBase
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            Hash = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.polkadot_core_primitives.CandidateHash();
            Hash.Decode(byteArray, ref p);
            Descriptor = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.polkadot_primitives.v1.CandidateDescriptor();
            Descriptor.Decode(byteArray, ref p);
            AvailabilityVotes = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.bitvec.order.Lsb0>();
            AvailabilityVotes.Decode(byteArray, ref p);
            Backers = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.bitvec.order.Lsb0>();
            ...
            BackingGroup = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9170.polkadot_primitives.v1.GroupIndex();
