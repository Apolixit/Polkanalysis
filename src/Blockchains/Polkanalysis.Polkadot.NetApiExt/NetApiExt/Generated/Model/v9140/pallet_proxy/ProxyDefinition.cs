...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9140.pallet_proxy
{
    /// <summary>
    /// >> 1712 - Composite[pallet_proxy.ProxyDefinition]
    /// </summary>
    ...
    public sealed class ProxyDefinition : ProxyDefinitionBase
    {
        ...
        {
            var start = p;
            Delegate = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9140.sp_core.crypto.AccountId32();
            Delegate.Decode(byteArray, ref p);
            ProxyType = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9140.polkadot_runtime.EnumProxyType();
