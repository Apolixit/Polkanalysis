...
{
    /// <summary>
    /// >> 12290 - Composite[pallet_bags_list.list.Bag]
    /// </summary>
    ...
    public sealed class Bag : BagBase
    {
        ...
        {
            var start = p;
            Head = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.sp_core.crypto.AccountId32>();
            Head.Decode(byteArray, ref p);
            Tail = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.sp_core.crypto.AccountId32>();
