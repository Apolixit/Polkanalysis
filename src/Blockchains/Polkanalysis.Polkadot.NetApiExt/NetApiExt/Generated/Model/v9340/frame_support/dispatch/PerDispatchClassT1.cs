...
{
    /// <summary>
    /// >> 11684 - Composite[frame_support.dispatch.PerDispatchClassT1]
    /// </summary>
    ...
    public sealed class PerDispatchClassT1 : PerDispatchClassT1Base
    {
        ...
        {
            var start = p;
            Normal = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.sp_weights.weight_v2.Weight();
            Normal.Decode(byteArray, ref p);
            Operational = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.sp_weights.weight_v2.Weight();
            Operational.Decode(byteArray, ref p);
            Mandatory = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.sp_weights.weight_v2.Weight();
