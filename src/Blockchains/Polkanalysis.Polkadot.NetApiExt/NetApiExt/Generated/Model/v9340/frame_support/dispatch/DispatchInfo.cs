...
{
    /// <summary>
    /// >> 11698 - Composite[frame_support.dispatch.DispatchInfo]
    /// </summary>
    ...
    public sealed class DispatchInfo : DispatchInfoBase
    {
        ...
        {
            var start = p;
            Weight = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.sp_weights.weight_v2.Weight();
            Weight.Decode(byteArray, ref p);
            Class = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.frame_support.dispatch.EnumDispatchClass();
            Class.Decode(byteArray, ref p);
            PaysFee = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.frame_support.dispatch.EnumPays();
