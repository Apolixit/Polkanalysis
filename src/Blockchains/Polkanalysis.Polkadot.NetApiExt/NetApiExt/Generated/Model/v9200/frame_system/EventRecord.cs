...
{
    /// <summary>
    /// >> 4573 - Composite[frame_system.EventRecord]
    /// </summary>
    ...
    public sealed class EventRecord : EventRecordBase
    {
        ...
        {
            var start = p;
            Phase = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.frame_system.EnumPhase();
            Phase.Decode(byteArray, ref p);
            Event = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_runtime.EnumEvent();
            Event.Decode(byteArray, ref p);
            Topics = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.primitive_types.H256>();
