...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.pallet_treasury
{
    /// <summary>
    /// >> 5092 - Composite[pallet_treasury.Proposal]
    /// </summary>
    ...
    public sealed class Proposal : ProposalBase
    {
        ...
        {
            var start = p;
            Proposer = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.sp_core.crypto.AccountId32();
            Proposer.Decode(byteArray, ref p);
            Value = new Substrate.NetApi.Model.Types.Primitive.U128();
            Value.Decode(byteArray, ref p);
            Beneficiary = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.sp_core.crypto.AccountId32();
