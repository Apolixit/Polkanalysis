...
{
    /// <summary>
    /// >> 2407 - Composite[polkadot_runtime_parachains.inclusion.CandidatePendingAvailability]
    /// </summary>
    ...
    public sealed class CandidatePendingAvailability : CandidatePendingAvailabilityBase
    {
        ...
        {
            var start = p;
            Core = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9151.polkadot_primitives.v1.CoreIndex();
            Core.Decode(byteArray, ref p);
            Hash = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9151.polkadot_core_primitives.CandidateHash();
            ...
            AvailabilityVotes = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9151.bitvec.order.Lsb0>();
            AvailabilityVotes.Decode(byteArray, ref p);
            Backers = new Substrate.NetApi.Model.Types.Base.BaseBitSeq<Substrate.NetApi.Model.Types.Primitive.U8, Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9151.bitvec.order.Lsb0>();
            ...
            BackingGroup = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9151.polkadot_primitives.v1.GroupIndex();
