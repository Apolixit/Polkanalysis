...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9420.pallet_proxy
{
    /// <summary>
    /// >> 14551 - Composite[pallet_proxy.ProxyDefinition]
    /// </summary>
    ...
    public sealed class ProxyDefinition : ProxyDefinitionBase
    {
        ...
        {
            var start = p;
            Delegate = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9420.sp_core.crypto.AccountId32();
            Delegate.Decode(byteArray, ref p);
            ProxyType = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9420.polkadot_runtime.EnumProxyType();
