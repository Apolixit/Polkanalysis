...
{
    /// <summary>
    /// >> 12796 - Composite[polkadot_primitives.v2.InherentData]
    /// </summary>
    ...
    public sealed class InherentData : InherentDataBase
    {
        ...
        {
            var start = p;
            Bitfields = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9360.polkadot_primitives.v2.signed.UncheckedSigned>();
            Bitfields.Decode(byteArray, ref p);
            BackedCandidates = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9360.polkadot_primitives.v2.BackedCandidate>();
            ...
            ParentHeader = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9360.sp_runtime.generic.header.Header();
