...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.pallet_proxy
{
    /// <summary>
    /// >> 478 - Composite[pallet_proxy.ProxyDefinition]
    /// </summary>
    ...
    public sealed class ProxyDefinition : ProxyDefinitionBase
    {
        ...
        {
            var start = p;
            Delegate = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.sp_core.crypto.AccountId32();
            Delegate.Decode(byteArray, ref p);
            ProxyType = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.polkadot_runtime.EnumProxyType();
