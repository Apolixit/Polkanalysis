...
{
    /// <summary>
    /// >> 325 - Composite[polkadot_primitives.v1.CandidateCommitments]
    /// </summary>
    ...
    public sealed class CandidateCommitments : CandidateCommitmentsBase
    {
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            HorizontalMessages = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.polkadot_core_primitives.OutboundHrmpMessage>();
            HorizontalMessages.Decode(byteArray, ref p);
            NewValidationCode = new Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.polkadot_parachain.primitives.ValidationCode>();
            NewValidationCode.Decode(byteArray, ref p);
            HeadData = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.polkadot_parachain.primitives.HeadData();
