...
{
    /// <summary>
    /// >> 10054 - Composite[pallet_identity.types.RegistrarInfo]
    /// </summary>
    ...
    public sealed class RegistrarInfo : RegistrarInfoBase
    {
        ...
        {
            var start = p;
            Account = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_core.crypto.AccountId32();
            Account.Decode(byteArray, ref p);
            Fee = new Substrate.NetApi.Model.Types.Primitive.U128();
            Fee.Decode(byteArray, ref p);
            Fields = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.pallet_identity.types.BitFlags();
