...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9260
{
    public sealed class ParaSessionInfoStorage
    {
        ...
        ///  When in doubt, use `Sessions` API instead.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9260.polkadot_primitives.v2.assignment_app.Public>> AssignmentKeysUnsafe(CancellationToken token)
        {
            string parameters = AssignmentKeysUnsafeParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9260.polkadot_primitives.v2.assignment_app.Public>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Does not have any entries before the session index in the first session change notification.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9260.polkadot_primitives.v2.SessionInfo> Sessions(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = SessionsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9260.polkadot_primitives.v2.SessionInfo>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  The validator account keys of the validators actively participating in parachain consensus.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9260.sp_core.crypto.AccountId32>> AccountKeys(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
