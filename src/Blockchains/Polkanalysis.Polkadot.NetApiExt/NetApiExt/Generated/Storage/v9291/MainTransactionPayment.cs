...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9291
{
    public sealed class TransactionPaymentStorage
    {
        ...
        /// >> NextFeeMultiplier
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.sp_arithmetic.fixed_point.FixedU128> NextFeeMultiplier(CancellationToken token)
        {
            string parameters = NextFeeMultiplierParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.sp_arithmetic.fixed_point.FixedU128>(parameters, blockHash, token);
            return result;
        }
        ...
        /// >> StorageVersion
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.pallet_transaction_payment.EnumReleases> StorageVersion(CancellationToken token)
        {
            string parameters = StorageVersionParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.pallet_transaction_payment.EnumReleases>(parameters, blockHash, token);
            return result;
        }
