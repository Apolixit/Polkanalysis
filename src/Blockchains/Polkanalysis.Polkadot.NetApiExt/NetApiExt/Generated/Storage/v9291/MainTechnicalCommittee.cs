...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9291
{
    public sealed class TechnicalCommitteeStorage
    {
        ...
        ///  The hashes of the active proposals.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.primitive_types.H256>> Proposals(CancellationToken token)
        {
            string parameters = ProposalsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.primitive_types.H256>>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ProposalOfParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.primitive_types.H256 key)
        {
        ...
        ///  Actual proposal for a given hash, if it's current.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.polkadot_runtime.EnumCall> ProposalOf(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = ProposalOfParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.polkadot_runtime.EnumCall>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string VotingParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.primitive_types.H256 key)
        {
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.pallet_collective.Votes> Voting(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = VotingParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9291.pallet_collective.Votes>(parameters, blockHash, token);
            return result;
        }
