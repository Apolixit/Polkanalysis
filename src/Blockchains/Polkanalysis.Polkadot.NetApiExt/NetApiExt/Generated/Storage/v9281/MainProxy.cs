...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9281
{
    public sealed class ProxyStorage
    {
        ...
        /// </summary>
        public static string ProxiesParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  which are being delegated to, together with the amount held on deposit.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.pallet_proxy.ProxyDefinition>, Substrate.NetApi.Model.Types.Primitive.U128>> Proxies(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = ProxiesParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.pallet_proxy.ProxyDefinition>, Substrate.NetApi.Model.Types.Primitive.U128>>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string AnnouncementsParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The announcements made by the proxy (key).
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.pallet_proxy.Announcement>, Substrate.NetApi.Model.Types.Primitive.U128>> Announcements(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = AnnouncementsParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.pallet_proxy.Announcement>, Substrate.NetApi.Model.Types.Primitive.U128>>(parameters, blockHash, token);
            return result;
        }
