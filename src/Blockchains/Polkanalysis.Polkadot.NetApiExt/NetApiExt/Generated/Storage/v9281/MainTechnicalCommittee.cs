...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9281
{
    public sealed class TechnicalCommitteeStorage
    {
        ...
        ///  The hashes of the active proposals.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.primitive_types.H256>> Proposals(CancellationToken token)
        {
        ...
        /// </summary>
        public static string ProposalOfParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.primitive_types.H256 key)
        {
        ...
        ///  Actual proposal for a given hash, if it's current.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.polkadot_runtime.EnumCall> ProposalOf(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = ProposalOfParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.polkadot_runtime.EnumCall>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string VotingParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.primitive_types.H256 key)
        {
        ...
        ///  Votes on a given proposal, if it is ongoing.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.pallet_collective.Votes> Voting(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = VotingParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.pallet_collective.Votes>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  The current members of the collective. This is stored sorted (just by value).
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_core.crypto.AccountId32>> Members(CancellationToken token)
        {
        ...
        ///  The prime member that helps determine the default vote behavior in case of absentations.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_core.crypto.AccountId32> Prime(CancellationToken token)
        {
