...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9281
{
    public sealed class SystemStorage
    {
        ...
        /// </summary>
        public static string AccountParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.AccountInfo> Account(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = AccountParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.AccountInfo>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  The current weight for the block.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_support.weights.PerDispatchClassT1> BlockWeight(CancellationToken token)
        {
            string parameters = BlockWeightParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_support.weights.PerDispatchClassT1>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.primitive_types.H256> BlockHash(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = BlockHashParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.primitive_types.H256>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Hash of the previous block.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.primitive_types.H256> ParentHash(CancellationToken token)
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_runtime.generic.digest.Digest> Digest(CancellationToken token)
        {
            string parameters = DigestParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_runtime.generic.digest.Digest>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.EventRecord>> Events(CancellationToken token)
        {
            string parameters = EventsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.EventRecord>>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string EventTopicsParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.primitive_types.H256 key)
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgrade(CancellationToken token)
        {
            string parameters = LastRuntimeUpgradeParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.LastRuntimeUpgradeInfo>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  The execution phase of the block.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.EnumPhase> ExecutionPhase(CancellationToken token)
        {
            string parameters = ExecutionPhaseParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.EnumPhase>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class SystemConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.limits.BlockWeights BlockWeights()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.limits.BlockWeights();
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.limits.BlockLength BlockLength()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_system.limits.BlockLength();
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_support.weights.RuntimeDbWeight DbWeight()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.frame_support.weights.RuntimeDbWeight();
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_version.RuntimeVersion Version()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9281.sp_version.RuntimeVersion();
            result.Create("");
            return result;
        }
