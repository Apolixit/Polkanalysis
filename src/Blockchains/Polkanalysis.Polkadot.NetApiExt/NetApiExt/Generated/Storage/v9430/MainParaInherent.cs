...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9430
{
    public sealed class ParaInherentStorage
    {
        ...
        ///  Scraped on chain data for extracting resolved disputes as well as backing votes.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.ScrapedOnChainVotes> OnChainVotes(CancellationToken token)
        {
            string parameters = OnChainVotesParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9430.polkadot_primitives.v4.ScrapedOnChainVotes>(parameters, blockHash, token);
            return result;
        }
