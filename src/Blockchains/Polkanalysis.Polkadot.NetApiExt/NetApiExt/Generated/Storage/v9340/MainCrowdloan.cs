...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9340
{
    public sealed class CrowdloanStorage
    {
        ...
        /// </summary>
        public static string FundsParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_parachain.primitives.Id key)
        {
        ...
        ///  Info on all of the funds.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_runtime_common.crowdloan.FundInfo> Funds(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_parachain.primitives.Id key, CancellationToken token)
        {
            string parameters = FundsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_runtime_common.crowdloan.FundInfo>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  in order to determine which funds should submit new or updated bids.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_parachain.primitives.Id>> NewRaise(CancellationToken token)
        {
