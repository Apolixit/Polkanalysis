...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9340
{
    public sealed class RegistrarStorage
    {
        ...
        /// </summary>
        public static string PendingSwapParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_parachain.primitives.Id key)
        {
        ...
        ///  Pending swap operations.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_parachain.primitives.Id> PendingSwap(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_parachain.primitives.Id key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string ParasParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_parachain.primitives.Id key)
        {
        ...
        ///  so if it isn't yet registered. (After that, it's up to governance to do so.)
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_runtime_common.paras_registrar.ParaInfo> Paras(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_parachain.primitives.Id key, CancellationToken token)
        {
            string parameters = ParasParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_runtime_common.paras_registrar.ParaInfo>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  The next free `ParaId`.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.polkadot_parachain.primitives.Id> NextFreeParaId(CancellationToken token)
        {
