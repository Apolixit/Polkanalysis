...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9340
{
    public sealed class PreimageStorage
    {
        ...
        /// </summary>
        public static string StatusForParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.primitive_types.H256 key)
        {
        ...
        ///  The request status of a given hash.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.pallet_preimage.EnumRequestStatus> StatusFor(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = StatusForParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.pallet_preimage.EnumRequestStatus>(parameters, blockHash, token);
            return result;
        }
        ...
        /// >> PreimageForParams
        /// </summary>
        public static string PreimageForParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9340.primitive_types.H256, Substrate.NetApi.Model.Types.Primitive.U32> key)
        {
