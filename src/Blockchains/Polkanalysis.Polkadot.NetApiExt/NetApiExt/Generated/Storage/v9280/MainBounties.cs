...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9280
{
    public sealed class BountiesStorage
    {
        ...
        ///  Bounties that have been made.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9280.pallet_bounties.Bounty> Bounties(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = BountiesParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9280.pallet_bounties.Bounty>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class BountiesConstants
    {
        ...
        ///  `CuratorDepositMin`.
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9280.sp_arithmetic.per_things.Permill CuratorDepositMultiplier()
        {
