...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9122
{
    public sealed class BabeStorage
    {
        ...
        ///  Current epoch authorities.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_babe.app.Public, Substrate.NetApi.Model.Types.Primitive.U64>>> Authorities(CancellationToken token)
        {
            string parameters = AuthoritiesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_babe.app.Public, Substrate.NetApi.Model.Types.Primitive.U64>>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  until the first block of the chain.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_slots.Slot> GenesisSlot(CancellationToken token)
        {
            string parameters = GenesisSlotParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_slots.Slot>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Current slot number.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_slots.Slot> CurrentSlot(CancellationToken token)
        {
        ...
        ///  Pending epoch configuration change that will be applied when the next epoch is enacted.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_babe.digests.EnumNextConfigDescriptor> PendingEpochConfigChange(CancellationToken token)
        {
            string parameters = PendingEpochConfigChangeParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_babe.digests.EnumNextConfigDescriptor>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Next epoch authorities.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_babe.app.Public, Substrate.NetApi.Model.Types.Primitive.U64>>> NextAuthorities(CancellationToken token)
        {
        ...
        ///  genesis.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_babe.BabeEpochConfiguration> EpochConfig(CancellationToken token)
        {
            string parameters = EpochConfigParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_babe.BabeEpochConfiguration>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  (you can fallback to `EpochConfig` instead in that case).
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9122.sp_consensus_babe.BabeEpochConfiguration> NextEpochConfig(CancellationToken token)
        {
