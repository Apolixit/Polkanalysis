...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9110
{
    public sealed class TransactionPaymentStorage
    {
        ...
        /// >> NextFeeMultiplier
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.sp_arithmetic.fixed_point.FixedU128> NextFeeMultiplier(CancellationToken token)
        {
            string parameters = NextFeeMultiplierParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.sp_arithmetic.fixed_point.FixedU128>(parameters, blockHash, token);
            return result;
        }
        ...
        /// >> StorageVersion
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.pallet_transaction_payment.EnumReleases> StorageVersion(CancellationToken token)
        {
            string parameters = StorageVersionParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.pallet_transaction_payment.EnumReleases>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class TransactionPaymentConstants
    {
        ...
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.frame_support.weights.WeightToFeeCoefficient> WeightToFee()
        {
            var result = new Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9110.frame_support.weights.WeightToFeeCoefficient>();
