...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9200
{
    public sealed class TreasuryStorage
    {
        ...
        ///  Proposals that have been made.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.pallet_treasury.Proposal> Proposals(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = ProposalsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.pallet_treasury.Proposal>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class TreasuryConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.sp_arithmetic.per_things.Permill ProposalBond()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.sp_arithmetic.per_things.Permill();
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.sp_arithmetic.per_things.Permill Burn()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.sp_arithmetic.per_things.Permill();
