...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9200
{
    public sealed class ParaSchedulerStorage
    {
        ...
        ///  Reasonably, 100-1000. The dominant factor is the number of validators: safe upper bound at 10k.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_primitives.v2.ValidatorIndex>>> ValidatorGroups(CancellationToken token)
        {
            string parameters = ValidatorGroupsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_primitives.v2.ValidatorIndex>>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  multiplied by the number of parathread multiplexer cores. Reasonably, 10 * 50 = 500.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_runtime_parachains.scheduler.ParathreadClaimQueue> ParathreadQueue(CancellationToken token)
        {
            string parameters = ParathreadQueueParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_runtime_parachains.scheduler.ParathreadClaimQueue>(parameters, blockHash, token);
            return result;
        }
        ...
        ///    * The number of validators divided by `configuration.max_validators_per_core`.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_primitives.v2.EnumCoreOccupied>>> AvailabilityCores(CancellationToken token)
        {
            string parameters = AvailabilityCoresParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_primitives.v2.EnumCoreOccupied>>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Bounded by the number of parathread cores and scheduling lookahead. Reasonably, 10 * 50 = 500.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_parachain.primitives.Id>> ParathreadClaimIndex(CancellationToken token)
        {
        ...
        ///  for the upcoming block.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_runtime_parachains.scheduler.CoreAssignment>> Scheduled(CancellationToken token)
        {
            string parameters = ScheduledParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.polkadot_runtime_parachains.scheduler.CoreAssignment>>(parameters, blockHash, token);
            return result;
        }
