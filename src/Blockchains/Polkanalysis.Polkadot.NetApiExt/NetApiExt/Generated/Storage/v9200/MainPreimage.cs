...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9200
{
    public sealed class PreimageStorage
    {
        ...
        /// </summary>
        public static string StatusForParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.primitive_types.H256 key)
        {
        ...
        ///  The request status of a given hash.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.pallet_preimage.EnumRequestStatus> StatusFor(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = StatusForParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.pallet_preimage.EnumRequestStatus>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string PreimageForParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.primitive_types.H256 key)
        {
        ...
        ///  The preimages stored by this pallet.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> PreimageFor(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9200.primitive_types.H256 key, CancellationToken token)
        {
