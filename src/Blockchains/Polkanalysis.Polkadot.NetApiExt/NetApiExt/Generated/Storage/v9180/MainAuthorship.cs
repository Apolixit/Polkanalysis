...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9180
{
    public sealed class AuthorshipStorage
    {
        ...
        ///  Uncles
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9180.pallet_authorship.EnumUncleEntryItem>> Uncles(CancellationToken token)
        {
            string parameters = UnclesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9180.pallet_authorship.EnumUncleEntryItem>>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9180.sp_core.crypto.AccountId32> Author(CancellationToken token)
        {
