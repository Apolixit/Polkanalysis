...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9300
{
    public sealed class InitializerStorage
    {
        ...
        ///  upgrade boundaries or if governance intervenes.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.polkadot_runtime_parachains.initializer.BufferedSessionChange>> BufferedSessionChanges(CancellationToken token)
        {
            string parameters = BufferedSessionChangesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.polkadot_runtime_parachains.initializer.BufferedSessionChange>>(parameters, blockHash, token);
            return result;
        }
