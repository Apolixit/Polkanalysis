...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9300
{
    public sealed class NominationPoolsStorage
    {
        ...
        ///  Active members.
        /// </summary>
        public static string PoolMembersParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Active members.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.pallet_nomination_pools.PoolMember> PoolMembers(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = PoolMembersParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.pallet_nomination_pools.PoolMember>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Storage for bonded pools.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.pallet_nomination_pools.BondedPoolInner> BondedPools(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = BondedPoolsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.pallet_nomination_pools.BondedPoolInner>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  is claimed, the balance comes out fo the reward pool. Keyed by the bonded pools account.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.pallet_nomination_pools.RewardPool> RewardPools(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = RewardPoolsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.pallet_nomination_pools.RewardPool>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  hence the name sub-pools. Keyed by the bonded pools account.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.pallet_nomination_pools.SubPools> SubPoolsStorage(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = SubPoolsStorageParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.pallet_nomination_pools.SubPools>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ReversePoolIdLookupParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  accounts are deterministically derived from it.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> ReversePoolIdLookup(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
    ...
    public sealed class NominationPoolsConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.frame_support.PalletId PalletId()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9300.frame_support.PalletId();
