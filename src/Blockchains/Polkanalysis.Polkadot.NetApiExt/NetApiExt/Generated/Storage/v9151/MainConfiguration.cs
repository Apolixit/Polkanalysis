...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9151
{
    public sealed class ConfigurationStorage
    {
        ...
        ///  The active configuration for the current session.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9151.polkadot_runtime_parachains.configuration.HostConfiguration> ActiveConfig(CancellationToken token)
        {
            string parameters = ActiveConfigParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9151.polkadot_runtime_parachains.configuration.HostConfiguration>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Pending configuration (if any) for the next session.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9151.polkadot_runtime_parachains.configuration.HostConfiguration> PendingConfig(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
