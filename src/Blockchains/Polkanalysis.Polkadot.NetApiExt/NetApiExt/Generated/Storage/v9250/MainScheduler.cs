...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9250
{
    public sealed class SchedulerStorage
    {
        ...
        ///  Items to be executed, indexed by the block number that they should be executed on.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.pallet_scheduler.ScheduledV3>>> Agenda(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = AgendaParams(key);
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseOpt<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.pallet_scheduler.ScheduledV3>>>(parameters, blockHash, token);
            return result;
        }
