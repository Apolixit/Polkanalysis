...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9250
{
    public sealed class ClaimsStorage
    {
        ...
        /// >> ClaimsParams
        /// </summary>
        public static string ClaimsParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.polkadot_runtime_common.claims.EthereumAddress key)
        {
        ...
        /// >> Claims
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U128> Claims(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.polkadot_runtime_common.claims.EthereumAddress key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VestingParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.polkadot_runtime_common.claims.EthereumAddress key)
        {
        ...
        /// </summary>
        public static string SigningParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.polkadot_runtime_common.claims.EthereumAddress key)
        {
        ...
        ///  The statement kind that must be signed, if any.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.polkadot_runtime_common.claims.EnumStatementKind> Signing(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.polkadot_runtime_common.claims.EthereumAddress key, CancellationToken token)
        {
            string parameters = SigningParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.polkadot_runtime_common.claims.EnumStatementKind>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string PreclaimsParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Pre-claimed Ethereum accounts, by the Account ID that they are claimed to.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.polkadot_runtime_common.claims.EthereumAddress> Preclaims(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = PreclaimsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9250.polkadot_runtime_common.claims.EthereumAddress>(parameters, blockHash, token);
            return result;
        }
