...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9360
{
    public sealed class OffencesStorage
    {
        ...
        /// </summary>
        public static string ReportsParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9360.primitive_types.H256 key)
        {
        ...
        ///  The primary structure that holds all offence records keyed by report identifiers.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9360.sp_staking.offence.OffenceDetails> Reports(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9360.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = ReportsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9360.sp_staking.offence.OffenceDetails>(parameters, blockHash, token);
            return result;
        }
