...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9220
{
    public sealed class BagsListStorage
    {
        ...
        /// </summary>
        public static string ListNodesParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Nodes store links forward and back within their respective bags.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.pallet_bags_list.list.Node> ListNodes(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = ListNodesParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.pallet_bags_list.list.Node>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Stores a `Bag` struct, which stores head and tail pointers to itself.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.pallet_bags_list.list.Bag> ListBags(Substrate.NetApi.Model.Types.Primitive.U64 key, CancellationToken token)
        {
            string parameters = ListBagsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9220.pallet_bags_list.list.Bag>(parameters, blockHash, token);
            return result;
        }
