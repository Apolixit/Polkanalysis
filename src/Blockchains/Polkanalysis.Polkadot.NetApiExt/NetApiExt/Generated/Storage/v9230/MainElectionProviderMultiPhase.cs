...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9230
{
    public sealed class ElectionProviderMultiPhaseStorage
    {
        ...
        ///  Current phase.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.EnumPhase> CurrentPhase(CancellationToken token)
        {
            string parameters = CurrentPhaseParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.EnumPhase>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Current best solution, signed or unsigned, queued to be returned upon `elect`.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.ReadySolution> QueuedSolution(CancellationToken token)
        {
            string parameters = QueuedSolutionParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.ReadySolution>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  This is created at the beginning of the signed phase and cleared upon calling `elect`.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.RoundSnapshot> Snapshot(CancellationToken token)
        {
            string parameters = SnapshotParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.RoundSnapshot>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Only exists when [`Snapshot`] is present.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.SolutionOrSnapshotSize> SnapshotMetadata(CancellationToken token)
        {
            string parameters = SnapshotMetadataParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.SolutionOrSnapshotSize>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  them one at a time instead of reading and decoding all of them at once.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.frame_support.storage.bounded_btree_map.BoundedBTreeMap> SignedSubmissionIndices(CancellationToken token)
        {
            string parameters = SignedSubmissionIndicesParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.frame_support.storage.bounded_btree_map.BoundedBTreeMap>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  affect; we shouldn't need a cryptographically secure hasher.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.signed.SignedSubmission> SignedSubmissionsMap(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = SignedSubmissionsMapParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_election_provider_multi_phase.signed.SignedSubmission>(parameters, blockHash, token);
            return result;
        }
        ...
        ///  Can be set via `set_minimum_untrusted_score`.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.sp_npos_elections.ElectionScore> MinimumUntrustedScore(CancellationToken token)
        {
            string parameters = MinimumUntrustedScoreParams();
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.sp_npos_elections.ElectionScore>(parameters, blockHash, token);
            return result;
        }
    ...
    public sealed class ElectionProviderMultiPhaseConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.sp_arithmetic.per_things.Perbill BetterSignedThreshold()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.sp_arithmetic.per_things.Perbill();
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.sp_arithmetic.per_things.Perbill BetterUnsignedThreshold()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.sp_arithmetic.per_things.Perbill();
        ...
        {
            var result = new Substrate.NetApi.Model.Types.Primitive.U64();
            result.Create("0x60B1FA4F57010000");
            return result;
        }
