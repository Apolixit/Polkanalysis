...
namespace Polkanalysis.Polkadot.NetApiExt.Generated.Storage.v9230
{
    public sealed class TipsStorage
    {
        ...
        /// </summary>
        public static string TipsParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.primitive_types.H256 key)
        {
        ...
        ///  guaranteed to be a secure hash.
        /// </summary>
        public async Task<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_tips.OpenTip> Tips(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = TipsParams(key);
            var result = await _client.GetStorageAsync<Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.pallet_tips.OpenTip>(parameters, blockHash, token);
            return result;
        }
        ...
        /// </summary>
        public static string ReasonsParams(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.primitive_types.H256 key)
        {
        ...
        ///  insecure enumerable hash since the key is guaranteed to be the result of a secure hash.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> Reasons(Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.primitive_types.H256 key, CancellationToken token)
        {
    ...
    public sealed class TipsConstants
    {
        ...
        /// </summary>
        public Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.sp_arithmetic.per_things.Percent TipFindersFee()
        {
            var result = new Polkanalysis.Polkadot.NetApiExt.Generated.Model.v9230.sp_arithmetic.per_things.Percent();
            result.Create("0x14");
            return result;
        }
