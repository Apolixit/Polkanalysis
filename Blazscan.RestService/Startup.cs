...
using Blazscan.RestService.Formatters;
...
namespace Blazscan.RestService
{
   ...
   public class Startup
   {
      ...
      public void ConfigureServices(IServiceCollection services)
      {
         ...
         else
         {
            ...
            _storageDataProvider = new AjunaSubstrateDataProvider(Environment.GetEnvironmentVariable("AJUNA_WEBSOCKET_ENDPOINT") ?? "wss://rpc.polkadot.io");
         }
         ...
         services.AddSwaggerGen(c =>
         {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "Blazscan.RestService", Version = "v1" });
         });
      }
      ...
      public void Configure(IApplicationBuilder app, IWebHostEnvironment env, StorageSubscriptionHandler handler)
      {
         ...
         app.UseSwaggerUI(
             c =>
             {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Blazscan.RestService v1");
             }
         );
