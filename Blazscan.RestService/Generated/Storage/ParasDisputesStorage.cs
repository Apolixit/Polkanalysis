...
namespace Blazscan.RestService.Generated.Storage
{
    ...
    public interface IParasDisputesStorage : IStorage
    {
        ...
        /// </summary>
        Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState GetDisputes(string key);
    ...
    public sealed class ParasDisputesStorage : IParasDisputesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState> _disputesTypedStorage;
        ...
        public ParasDisputesStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.DisputesTypedStorage = new TypedMapStorage<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState>("ParasDisputes.Disputes", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState> DisputesTypedStorage
        {
            get
            {
        ...
        ///  All ongoing or concluded disputes for the last several sessions.
        /// </summary>
        public Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState GetDisputes(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (DisputesTypedStorage.Dictionary.TryGetValue(key, out Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.DisputeState result))
            {
                return result;
            }
            else
