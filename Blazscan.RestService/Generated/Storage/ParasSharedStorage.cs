...
namespace Blazscan.RestService.Generated.Storage
{
    ...
    public interface IParasSharedStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex> GetActiveValidatorIndices();
        ...
        /// </summary>
        Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public> GetActiveValidatorKeys();
    }
    ...
    public sealed class ParasSharedStorage : IParasSharedStorage
    {
        ...
        /// </summary>
        private TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex>> _activeValidatorIndicesTypedStorage;
        
        /// <summary>
        /// _activeValidatorKeysTypedStorage typed storage field
        /// </summary>
        private TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public>> _activeValidatorKeysTypedStorage;
        ...
        public ParasSharedStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.ActiveValidatorIndicesTypedStorage = new TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex>>("ParasShared.ActiveValidatorIndices", storageDataProvider, storageChangeDelegates);
            this.ActiveValidatorKeysTypedStorage = new TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public>>("ParasShared.ActiveValidatorKeys", storageDataProvider, storageChangeDelegates);
        }
        ...
        /// </summary>
        public TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex>> ActiveValidatorIndicesTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public>> ActiveValidatorKeysTypedStorage
        {
            get
            {
        ...
        ///  Indices are into the broader validator set.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.ValidatorIndex> GetActiveValidatorIndices()
        {
        ...
        ///  This should be the same length as `ActiveValidatorIndices`.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.validator_app.Public> GetActiveValidatorKeys()
        {
