...
namespace Blazscan.RestService.Generated.Storage
{
    ...
    public interface ISessionStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> GetValidators();
        ...
        /// </summary>
        Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys>> GetQueuedKeys();
        ...
        /// </summary>
        Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys GetNextKeys(string key);
        
        /// <summary>
        /// >> KeyOwner
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetKeyOwner(string key);
    }
    ...
    public sealed class SessionStorage : ISessionStorage
    {
        ...
        /// </summary>
        private TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> _validatorsTypedStorage;
        ...
        /// </summary>
        private TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys>>> _queuedKeysTypedStorage;
        ...
        /// </summary>
        private TypedMapStorage<Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys> _nextKeysTypedStorage;
        
        /// <summary>
        /// _keyOwnerTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> _keyOwnerTypedStorage;
        ...
        {
            this.ValidatorsTypedStorage = new TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>>("Session.Validators", storageDataProvider, storageChangeDelegates);
            ...
            this.QueuedKeysTypedStorage = new TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys>>>("Session.QueuedKeys", storageDataProvider, storageChangeDelegates);
            ...
            this.NextKeysTypedStorage = new TypedMapStorage<Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys>("Session.NextKeys", storageDataProvider, storageChangeDelegates);
            this.KeyOwnerTypedStorage = new TypedMapStorage<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("Session.KeyOwner", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _validatorsTypedStorage property
        /// </summary>
        public TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> ValidatorsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys>>> QueuedKeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys> NextKeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> KeyOwnerTypedStorage
        {
            get
            {
        ...
        ///  The current set of validators.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> GetValidators()
        {
        ...
        ///  will be used to determine the validator's session keys.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseTuple<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys>> GetQueuedKeys()
        {
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys GetNextKeys(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (NextKeysTypedStorage.Dictionary.TryGetValue(key, out Blazscan.NetApiExt.Generated.Model.polkadot_runtime.SessionKeys result))
            {
                return result;
            }
            else
        ...
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        public Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 GetKeyOwner(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (KeyOwnerTypedStorage.Dictionary.TryGetValue(key, out Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 result))
            {
                return result;
            }
            else
