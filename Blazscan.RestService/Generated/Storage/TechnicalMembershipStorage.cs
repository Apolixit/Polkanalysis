...
namespace Blazscan.RestService.Generated.Storage
{
    ...
    public interface ITechnicalMembershipStorage : IStorage
    {
        ...
        /// </summary>
        Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT11 GetMembers();
    ...
    public sealed class TechnicalMembershipStorage : ITechnicalMembershipStorage
    {
        ...
        /// </summary>
        private TypedStorage<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT11> _membersTypedStorage;
        ...
        {
            this.MembersTypedStorage = new TypedStorage<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT11>("TechnicalMembership.Members", storageDataProvider, storageChangeDelegates);
            this.PrimeTypedStorage = new TypedStorage<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>("TechnicalMembership.Prime", storageDataProvider, storageChangeDelegates);
        }
        
        /// <summary>
        /// _membersTypedStorage property
        /// </summary>
        public TypedStorage<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT11> MembersTypedStorage
        {
            get
            {
        ...
        ///  The current membership, stored as an ordered Vec.
        /// </summary>
        public Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT11 GetMembers()
        {
