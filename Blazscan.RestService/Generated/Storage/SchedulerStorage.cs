...
namespace Blazscan.RestService.Generated.Storage
{
    ...
    public interface ISchedulerStorage : IStorage
    {
        ...
        /// </summary>
        Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.NetApiExt.Generated.Model.pallet_scheduler.ScheduledV3>> GetAgenda(string key);
    ...
    public sealed class SchedulerStorage : ISchedulerStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.NetApiExt.Generated.Model.pallet_scheduler.ScheduledV3>>> _agendaTypedStorage;
        ...
        {
            this.AgendaTypedStorage = new TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.NetApiExt.Generated.Model.pallet_scheduler.ScheduledV3>>>("Scheduler.Agenda", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.NetApiExt.Generated.Model.pallet_scheduler.ScheduledV3>>> AgendaTypedStorage
        {
            get
            {
        ...
        ///  Items to be executed, indexed by the block number that they should be executed on.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.NetApiExt.Generated.Model.pallet_scheduler.ScheduledV3>> GetAgenda(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (AgendaTypedStorage.Dictionary.TryGetValue(key, out Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.NetApiExt.Generated.Model.pallet_scheduler.ScheduledV3>> result))
            {
                return result;
            }
            else
