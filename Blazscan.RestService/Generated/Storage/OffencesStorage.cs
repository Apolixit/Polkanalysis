...
namespace Blazscan.RestService.Generated.Storage
{
    ...
    public interface IOffencesStorage : IStorage
    {
        ...
        /// </summary>
        Blazscan.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails GetReports(string key);
        
        /// <summary>
        /// >> ConcurrentReportsIndex
        ///  A vector of reports of the same kind that happened at the same time slot.
        /// </summary>
        Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.primitive_types.H256> GetConcurrentReportsIndex(string key);
    ...
    public sealed class OffencesStorage : IOffencesStorage
    {
        ...
        /// </summary>
        private TypedMapStorage<Blazscan.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails> _reportsTypedStorage;
        
        /// <summary>
        /// _concurrentReportsIndexTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.primitive_types.H256>> _concurrentReportsIndexTypedStorage;
        ...
        {
            this.ReportsTypedStorage = new TypedMapStorage<Blazscan.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails>("Offences.Reports", storageDataProvider, storageChangeDelegates);
            this.ConcurrentReportsIndexTypedStorage = new TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.primitive_types.H256>>("Offences.ConcurrentReportsIndex", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedMapStorage<Blazscan.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails> ReportsTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.primitive_types.H256>> ConcurrentReportsIndexTypedStorage
        {
            get
            {
        ...
        ///  The primary structure that holds all offence records keyed by report identifiers.
        /// </summary>
        public Blazscan.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails GetReports(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReportsTypedStorage.Dictionary.TryGetValue(key, out Blazscan.NetApiExt.Generated.Model.sp_staking.offence.OffenceDetails result))
            {
                return result;
            }
            else
        ...
        ///  A vector of reports of the same kind that happened at the same time slot.
        /// </summary>
        public Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.primitive_types.H256> GetConcurrentReportsIndex(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ConcurrentReportsIndexTypedStorage.Dictionary.TryGetValue(key, out Ajuna.NetApi.Model.Types.Base.BaseVec<Blazscan.NetApiExt.Generated.Model.primitive_types.H256> result))
            {
                return result;
            }
            else
