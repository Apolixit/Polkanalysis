...
namespace Blazscan.RestService.Generated.Storage
{
    ...
    public interface IImOnlineStorage : IStorage
    {
        ...
        /// </summary>
        Blazscan.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT5 GetKeys();
        ...
        /// </summary>
        Blazscan.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque GetReceivedHeartbeats(string key);
    ...
    public sealed class ImOnlineStorage : IImOnlineStorage
    {
        ...
        /// </summary>
        private TypedStorage<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT5> _keysTypedStorage;
        
        /// <summary>
        /// _receivedHeartbeatsTypedStorage typed storage field
        /// </summary>
        private TypedMapStorage<Blazscan.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque> _receivedHeartbeatsTypedStorage;
        ...
        public ImOnlineStorage(IStorageDataProvider storageDataProvider, List<IStorageChangeDelegate> storageChangeDelegates)
        {
            ...
            this.KeysTypedStorage = new TypedStorage<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT5>("ImOnline.Keys", storageDataProvider, storageChangeDelegates);
            this.ReceivedHeartbeatsTypedStorage = new TypedMapStorage<Blazscan.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque>("ImOnline.ReceivedHeartbeats", storageDataProvider, storageChangeDelegates);
        ...
        /// </summary>
        public TypedStorage<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT5> KeysTypedStorage
        {
            get
            {
        ...
        /// </summary>
        public TypedMapStorage<Blazscan.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque> ReceivedHeartbeatsTypedStorage
        {
            get
            {
        ...
        ///  The current set of keys that may issue a heartbeat.
        /// </summary>
        public Blazscan.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT5 GetKeys()
        {
        ...
        ///  `WrapperOpaque<BoundedOpaqueNetworkState>`.
        /// </summary>
        public Blazscan.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque GetReceivedHeartbeats(string key)
        {
            if ((key == null))
            {
                return null;
            }
            if (ReceivedHeartbeatsTypedStorage.Dictionary.TryGetValue(key, out Blazscan.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque result))
            {
                return result;
            }
            else
