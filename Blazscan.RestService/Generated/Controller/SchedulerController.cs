...
namespace Blazscan.RestService.Generated.Controller
{
    ...
    public sealed class SchedulerController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Agenda")]
        [ProducesResponseType(typeof(Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Base.BaseOpt<Blazscan.NetApiExt.Generated.Model.pallet_scheduler.ScheduledV3>>), 200)]
        [StorageKeyBuilder(typeof(Blazscan.NetApiExt.Generated.Storage.SchedulerStorage), "AgendaParams", typeof(Ajuna.NetApi.Model.Types.Primitive.U32))]
        ...
        [StorageKeyBuilder(typeof(Blazscan.NetApiExt.Generated.Storage.SchedulerStorage), "LookupParams", typeof(Ajuna.NetApi.Model.Types.Base.BaseVec<Ajuna.NetApi.Model.Types.Primitive.U8>))]
