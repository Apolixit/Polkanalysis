    ...
    public sealed class AuctionsStorage
    {
        ...
        public AuctionsStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Auctions", "ReservedAmounts"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Blazscan.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id>), typeof(Ajuna.NetApi.Model.Types.Primitive.U128)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Auctions", "Winning"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U32), typeof(Blazscan.NetApiExt.Generated.Types.Base.Arr36BaseOpt)));
        }
        ...
        ///  (sub-)ranges.
        /// </summary>
        public static string ReservedAmountsParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Blazscan.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id> key)
        {
        ...
        ///  (sub-)ranges.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U128> ReservedAmounts(Ajuna.NetApi.Model.Types.Base.BaseTuple<Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Blazscan.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id> key, CancellationToken token)
        {
        ...
        ///  first sample of the ending period is 0; the last is `Sample Size - 1`.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Types.Base.Arr36BaseOpt> Winning(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = AuctionsStorage.WinningParams(key);
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Types.Base.Arr36BaseOpt>(parameters, token);
        }
    }
