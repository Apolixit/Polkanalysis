...
namespace Blazscan.NetApiExt.Generated.Storage
{
    ...
    public sealed class ParaInherentStorage
    {
        ...
        public ParaInherentStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ParaInherent", "OnChainVotes"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.ScrapedOnChainVotes)));
        }
        ...
        ///  Scraped on chain data for extracting resolved disputes as well as backing votes.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.ScrapedOnChainVotes> OnChainVotes(CancellationToken token)
        {
            string parameters = ParaInherentStorage.OnChainVotesParams();
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.ScrapedOnChainVotes>(parameters, token);
        }
    }
    ...
    public sealed class ParaInherentCalls
    {
        ...
        /// </summary>
        public static Method Enter(Blazscan.NetApiExt.Generated.Model.polkadot_primitives.v2.InherentData data)
        {
