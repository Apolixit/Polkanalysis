...
namespace Blazscan.NetApiExt.Generated.Storage
{
    ...
    public sealed class VoterListStorage
    {
        ...
        public VoterListStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("VoterList", "ListNodes"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Blazscan.NetApiExt.Generated.Model.pallet_bags_list.list.Node)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("VoterList", "ListBags"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U64), typeof(Blazscan.NetApiExt.Generated.Model.pallet_bags_list.list.Bag)));
        }
        ...
        /// </summary>
        public static string ListNodesParams(Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Nodes store links forward and back within their respective bags.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.pallet_bags_list.list.Node> ListNodes(Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = VoterListStorage.ListNodesParams(key);
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.pallet_bags_list.list.Node>(parameters, token);
        }
        ...
        ///  Stores a `Bag` struct, which stores head and tail pointers to itself.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.pallet_bags_list.list.Bag> ListBags(Ajuna.NetApi.Model.Types.Primitive.U64 key, CancellationToken token)
        {
            string parameters = VoterListStorage.ListBagsParams(key);
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.pallet_bags_list.list.Bag>(parameters, token);
        }
    }
    ...
    public sealed class VoterListCalls
    {
        ...
        /// </summary>
        public static Method Rebag(Blazscan.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress dislocated)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method PutInFrontOf(Blazscan.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress lighter)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
