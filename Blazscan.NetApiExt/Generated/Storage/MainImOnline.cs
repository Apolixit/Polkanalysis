...
namespace Blazscan.NetApiExt.Generated.Storage
{
    ...
    public sealed class ImOnlineStorage
    {
        ...
        public ImOnlineStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ImOnline", "Keys"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Blazscan.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT5)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ImOnline", "ReceivedHeartbeats"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.NetApi.Model.Types.Primitive.U32>), typeof(Blazscan.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ImOnline", "AuthoredBlocks"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat,
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>), typeof(Ajuna.NetApi.Model.Types.Primitive.U32)));
        }
        ...
        ///  The current set of keys that may issue a heartbeat.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT5> Keys(CancellationToken token)
        {
            string parameters = ImOnlineStorage.KeysParams();
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.weak_bounded_vec.WeakBoundedVecT5>(parameters, token);
        }
        ...
        ///  `WrapperOpaque<BoundedOpaqueNetworkState>`.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque> ReceivedHeartbeats(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.NetApi.Model.Types.Primitive.U32> key, CancellationToken token)
        {
            string parameters = ImOnlineStorage.ReceivedHeartbeatsParams(key);
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.frame_support.traits.misc.WrapperOpaque>(parameters, token);
        }
        ...
        /// </summary>
        public static string AuthoredBlocksParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key)
        {
        ...
        ///  number of blocks authored by the given authority.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U32> AuthoredBlocks(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> key, CancellationToken token)
        {
    ...
    public sealed class ImOnlineCalls
    {
        ...
        /// </summary>
        public static Method Heartbeat(Blazscan.NetApiExt.Generated.Model.pallet_im_online.Heartbeat heartbeat, Blazscan.NetApiExt.Generated.Model.pallet_im_online.sr25519.app_sr25519.Signature signature)
        {
