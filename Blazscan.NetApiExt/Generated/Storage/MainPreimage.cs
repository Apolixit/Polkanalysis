...
namespace Blazscan.NetApiExt.Generated.Storage
{
    ...
    public sealed class PreimageStorage
    {
        ...
        public PreimageStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Preimage", "StatusFor"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Blazscan.NetApiExt.Generated.Model.primitive_types.H256), typeof(Blazscan.NetApiExt.Generated.Model.pallet_preimage.EnumRequestStatus)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Preimage", "PreimageFor"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Blazscan.NetApiExt.Generated.Model.primitive_types.H256), typeof(Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT2)));
        }
        ...
        /// </summary>
        public static string StatusForParams(Blazscan.NetApiExt.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  The request status of a given hash.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.pallet_preimage.EnumRequestStatus> StatusFor(Blazscan.NetApiExt.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = PreimageStorage.StatusForParams(key);
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.pallet_preimage.EnumRequestStatus>(parameters, token);
        }
        ...
        /// </summary>
        public static string PreimageForParams(Blazscan.NetApiExt.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  The preimages stored by this pallet.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT2> PreimageFor(Blazscan.NetApiExt.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
            string parameters = PreimageStorage.PreimageForParams(key);
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT2>(parameters, token);
        }
    }
    ...
    public sealed class PreimageCalls
    {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UnnotePreimage(Blazscan.NetApiExt.Generated.Model.primitive_types.H256 hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method RequestPreimage(Blazscan.NetApiExt.Generated.Model.primitive_types.H256 hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(hash.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method UnrequestPreimage(Blazscan.NetApiExt.Generated.Model.primitive_types.H256 hash)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(hash.Encode());
