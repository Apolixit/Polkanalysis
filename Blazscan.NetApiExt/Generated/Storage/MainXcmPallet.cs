...
namespace Blazscan.NetApiExt.Generated.Storage
{
    ...
    public sealed class XcmPalletStorage
    {
        ...
        public XcmPalletStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcmPallet", "Queries"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.NetApi.Model.Types.Primitive.U64), typeof(Blazscan.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcmPallet", "AssetTraps"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Identity}, typeof(Blazscan.NetApiExt.Generated.Model.primitive_types.H256), typeof(Ajuna.NetApi.Model.Types.Primitive.U32)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcmPallet", "SupportedVersion"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation>), typeof(Ajuna.NetApi.Model.Types.Primitive.U32)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcmPallet", "VersionNotifiers"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat,
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation>), typeof(Ajuna.NetApi.Model.Types.Primitive.U64)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcmPallet", "VersionNotifyTargets"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat,
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation>), typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U64, Ajuna.NetApi.Model.Types.Primitive.U64, Ajuna.NetApi.Model.Types.Primitive.U32>)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcmPallet", "VersionDiscoveryQueue"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("XcmPallet", "CurrentMigration"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Blazscan.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage)));
        }
        ...
        ///  The ongoing queries.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus> Queries(Ajuna.NetApi.Model.Types.Primitive.U64 key, CancellationToken token)
        {
            string parameters = XcmPalletStorage.QueriesParams(key);
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumQueryStatus>(parameters, token);
        }
        ...
        /// </summary>
        public static string AssetTrapsParams(Blazscan.NetApiExt.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  times this pair has been trapped (usually just 1 if it exists at all).
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U32> AssetTraps(Blazscan.NetApiExt.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string SupportedVersionParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key)
        {
        ...
        ///  The Latest versions that we know various locations support.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U32> SupportedVersion(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VersionNotifiersParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key)
        {
        ...
        ///  All locations that we have requested version notifications from.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Primitive.U64> VersionNotifiers(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key, CancellationToken token)
        {
        ...
        /// </summary>
        public static string VersionNotifyTargetsParams(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key)
        {
        ...
        ///  of our versions we informed them of.
        /// </summary>
        public async Task<Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U64, Ajuna.NetApi.Model.Types.Primitive.U64, Ajuna.NetApi.Model.Types.Primitive.U32>> VersionNotifyTargets(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation> key, CancellationToken token)
        {
        ...
        ///  which is used as a prioritization.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22> VersionDiscoveryQueue(CancellationToken token)
        {
            string parameters = XcmPalletStorage.VersionDiscoveryQueueParams();
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT22>(parameters, token);
        }
        ...
        ///  The current migration's stage, if any.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage> CurrentMigration(CancellationToken token)
        {
            string parameters = XcmPalletStorage.CurrentMigrationParams();
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.pallet_xcm.pallet.EnumVersionMigrationStage>(parameters, token);
        }
    }
    ...
    public sealed class XcmPalletCalls
    {
        ...
        /// </summary>
        public static Method Send(Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation dest, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedXcm message)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method TeleportAssets(Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation dest, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation beneficiary, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiAssets assets, Ajuna.NetApi.Model.Types.Primitive.U32 fee_asset_item)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ReserveTransferAssets(Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation dest, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation beneficiary, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiAssets assets, Ajuna.NetApi.Model.Types.Primitive.U32 fee_asset_item)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
            byteArray.AddRange(beneficiary.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method Execute(Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedXcm message, Blazscan.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight max_weight)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(message.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ForceXcmVersion(Blazscan.NetApiExt.Generated.Model.xcm.v1.multilocation.MultiLocation location, Ajuna.NetApi.Model.Types.Primitive.U32 xcm_version)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ForceSubscribeVersionNotify(Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(location.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ForceUnsubscribeVersionNotify(Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation location)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(location.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method LimitedReserveTransferAssets(Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation dest, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation beneficiary, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiAssets assets, Ajuna.NetApi.Model.Types.Primitive.U32 fee_asset_item, Blazscan.NetApiExt.Generated.Model.xcm.v2.EnumWeightLimit weight_limit)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
            byteArray.AddRange(beneficiary.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method LimitedTeleportAssets(Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation dest, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiLocation beneficiary, Blazscan.NetApiExt.Generated.Model.xcm.EnumVersionedMultiAssets assets, Ajuna.NetApi.Model.Types.Primitive.U32 fee_asset_item, Blazscan.NetApiExt.Generated.Model.xcm.v2.EnumWeightLimit weight_limit)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(dest.Encode());
            byteArray.AddRange(beneficiary.Encode());
