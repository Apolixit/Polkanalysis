    ...
    public sealed class ChildBountiesStorage
    {
        ...
        public ChildBountiesStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("ChildBounties", "ChildBounties"), new System.Tuple<Ajuna.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Ajuna.NetApi.Model.Meta.Storage.Hasher[] {
                            ...
                            Ajuna.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.NetApi.Model.Types.Primitive.U32>), typeof(Blazscan.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty)));
        ...
        ///  Child bounties that have been added.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty> ChildBounties(Ajuna.NetApi.Model.Types.Base.BaseTuple<Ajuna.NetApi.Model.Types.Primitive.U32, Ajuna.NetApi.Model.Types.Primitive.U32> key, CancellationToken token)
        {
            string parameters = ChildBountiesStorage.ChildBountiesParams(key);
            return await _client.GetStorageAsync<Blazscan.NetApiExt.Generated.Model.pallet_child_bounties.ChildBounty>(parameters, token);
        }
        ...
        ///  The description of each child-bounty.
        /// </summary>
        public async Task<Blazscan.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT19> ChildBountyDescriptions(Ajuna.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
